...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}));return t.renderOrder=-6,e.add(t),t}var $l=1500;function eu(e){let t=new Float32Array($l*3),n=new Float32Array($l),r=new Float32Array($l),i=new Float32Array($l*3),a=new U(.42,.72,-.55).normalize(),o=new U().crossVectors(new U(1,0,0),a).normalize(),s=new U().crossVectors(a,o).normalize(),c=new U;for(let e=0;e<$l;e++){if(e%5<2){let e=Math.random()*Math.PI*2,t=(Math.random()+Math.random()+Math.random()-1.5)*.17;c.copy(o).multiplyScalar(Math.cos(e)).addScaledVector(s,Math.sin(e)).addScaledVector(a,t)}else c.set(Math.random()*2-1,Math.random()*2-1,Math.random()*2-1),c.lengthSq()<.02&&c.set(0,1,0);c.normalize(),c.y=Math.abs(c.y)*.98+.02,c.normalize().multiplyScalar(Il),t[e*3]=c.x,t[e*3+1]=c.y,t[e*3+2]=c.z;let l=Math.random();n[e]=1+l*l*3.4,r[e]=Math.random();let u=Math.random(),d=u>.86,f=u<.18;i[e*3]=d?1:f?.78:.96,i[e*3+1]=d?.88:f?.86:.96,i[e*3+2]=d?.72:1}let l=new ur;l.setAttribute(`position`,new Yn(t,3)),l.setAttribute(`aSize`,new Yn(n,1)),l.setAttribute(`aPhase`,new Yn(r,1)),l.setAttribute(`aColor`,new Yn(i,3));let u=new Ii(l,new oa({transparent:!0,depthWrite:!1,depthTest:!1,blending:2,uniforms:{uOpacity:{value:0},uTime:{value:0},uPixelRatio:{value:Math.min(window.devicePixelRatio,2)}},vertexShader:`
    ...
    `}));return u.frustumCulled=!1,u.renderOrder=-9,e.add(u),u}function tu(e){let t=new ur;t.setAttribute(`position`,new Yn(new Float32Array(6),3));let n=new Ei(t,new vi({color:14674431,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,blending:2,fog:!1}));n.frustumCulled=!1,n.renderOrder=-5,n.visible=!1,e.add(n);let r=new U,i=new U,a=14+Math.random()*40,o=0;function s(){r.set(Math.random()*2-1,.25+Math.random()*.7,Math.random()*2-1).normalize().multiplyScalar(Il),i.set(Math.random()*2-1,-.35-Math.random()*.4,Math.random()*2-1).normalize(),o=1}return{update:function(e,t){if(t<.35){n.visible=!1;return}if(o<=0){if(a-=e,a>0){n.visible=!1;return}a=16+Math.random()*55,s()}o-=e*1.6;let c=n.geometry.attributes.position.array,l=(1-o)*130;c[0]=r.x+i.x*l,c[1]=r.y+i.y*l,c[2]=r.z+i.z*l,c[3]=c[0]-i.x*34,c[4]=c[1]-i.y*34,c[5]=c[2]-i.z*34,n.geometry.attributes.position.needsUpdate=!0,n.material.opacity=Math.max(0,Math.sin(Math.max(0,o)*Math.PI))*t,n.visible=o>0}}}var nu=15321994,ru=Math.PI,iu=1200,au=7,ou=.3,su=34,cu=2048,lu=75,uu={sun:16766874,sunI:1.25,glow:16777215,glowO:1,glowS:90,skyTop:8301014,skyMid:15911819,skyBottom:16245942,hemiSky:12112623,hemiGround:7164711,hemiI:.62,amb:16771780,ambI:.3,fog:nu,fogD:.02},du={sun:16747580,sunI:.45,glow:16751186,glowO:1,glowS:132,skyTop:3095654,skyMid:14517318,skyBottom:9394744,hemiSky:5531023,hemiGround:3352079,hemiI:.28,amb:12556928,ambI:.14,fog:12153916,fogD:.026},fu={sun:16738874,sunI:.1,glow:16742978,glowO:.52,glowS:152,skyTop:1975623,skyMid:9195346,skyBottom:5058360,hemiSky:4279418,hemiGround:2366225,hemiI:.22,amb:9664910,ambI:.13,fog:7160135,fogD:.026},pu={sun:3820160,sunI:0,glow:2898534,glowO:.14,glowS:124,skyTop:791344,skyMid:2240604,skyBottom:2765656,hemiSky:3162746,hemiGround:1514020,hemiI:.21,amb:5531038,ambI:.14,fog:2765656,fogD:.023},mu={sun:2634842,sunI:0,glow:1055283,glowO:0,glowS:100,skyTop:263953,skyMid:527904,skyBottom:922921,hemiSky:2372702,hemiGround:658968,hemiI:.2,amb:4478090,ambI:.14,fog:791076,fogD:.019},hu={sun:10645647,sunI:.06,glow:13600918,glowO:.38,glowS:140,skyTop:1712976,skyMid:8017280,skyBottom:4995678,hemiSky:4674190,hemiGround:1907236,hemiI:.24,amb:9144235,ambI:.15,fog:5981538,fogD:.029},gu={sun:16757880,sunI:.5,glow:16759178,glowO:.95,glowS:136,skyTop:4017536,skyMid:15771774,skyBottom:14328972,hemiSky:8689341,hemiGround:3813409,hemiI:.36,amb:14464166,ambI:.19,fog:13340276,fogD:.03},_u={sun:16771270,sunI:1.02,glow:16777215,glowO:.95,glowS:82,skyTop:7314898,skyMid:14081766,skyBottom:15328214,hemiSky:12901620,hemiGround:7035444,hemiI:.56,amb:15855584,ambI:.26,fog:14278100,fogD:.025},vu={sun:16773848,sunI:.9,glow:16777215,glowO:.88,glowS:68,skyTop:6263500,skyMid:11980772,skyBottom:14673120,hemiSky:13295602,hemiGround:8151604,hemiI:.5,amb:16775402,ambI:.22,fog:13620940,fogD:.024},yu=[[-1,mu],[-.23,mu],[-.115,pu],[-.035,fu],[.05,du],[.347,uu],[.78,vu],[1,vu]],bu=[[-1,mu],[-.23,mu],[-.115,pu],[-.035,hu],[.05,gu],[.347,_u],[.78,vu],[1,vu]],xu=[`sun`,`glow`,`skyTop`,`skyMid`,`skyBottom`,`hemiSky`,`hemiGround`,`amb`,`fog`],Su=[`sunI`,`glowO`,`glowS`,`hemiI`,`ambI`,`fogD`],Cu=[[0,159],[.09,176],[.213,200],[.433,330],[.653,380],[.953,510],[1,519]];function wu(e){let t=new gn;t.fog=new hn(nu,.02);let n=new La(64,window.innerWidth/window.innerHeight,.1,700),r=ku();document.body.appendChild(r.domElement),window.addEventListener(`resize`,function(){n.aspect=window.innerWidth/window.innerHeight,n.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)});let i=r.capabilities.getMaxAnisotropy(),a=Hl(t),o=Au(t);return Mu(t,e,i),{scene:t,camera:n,renderer:r,maxAniso:i,daylight:Tu(r,t,a,o,n)}}function Tu(e,t,n,r,i){let a={};for(let e=0;e<xu.length;e++)a[xu[e]]=new K;let o=new K,s=new K,c=new U;function l(e,t){let n=1;for(;n<e.length-1&&e[n][0]<t;)n++;let r=n-1,i=e[n][0]-e[r][0],c=Du(i>0?(t-e[r][0])/i:0),l=e[r][1],u=e[n][1];for(let e=0;e<xu.length;e++){let t=xu[e];o.setHex(l[t]),s.setHex(u[t]),a[t].copy(o).lerp(s,c)}for(let e=0;e<Su.length;e++){let t=Su[e];a[t]=l[t]+(u[t]-l[t])*c}}function u(e){let t=1;for(;t<Cu.length-1&&Cu[t][0]<e;)t++;let n=t-1,r=Cu[t][0]-Cu[n][0],i=r>0?(e-Cu[n][0])/r:0;return(Cu[n][1]+(Cu[t][1]-Cu[n][1])*i)*Math.PI/180}let d={fogBoost:0,lightDamp:0},f=0,p=2+Math.random()*1.4,m={cameraPosition:i.position,skyTop:a.skyTop,skyMid:a.skyMid,skyBottom:a.skyBottom,glowColor:a.glow,glowOpacity:1,glowScale:90,sunTheta:0,moonTheta:0,moonPhi:Math.PI,starOpacity:0,night:0,elevation:0,moonlight:0,time:0};function h(o){let s=f/iu,h=u(s%1);Vl(h,c);let g=c.y/c.length();l(Math.cos(h)>0?bu:yu,g);let _=d.lightDamp;r.sun.position.copy(c).normalize().multiplyScalar(lu).add(i.position),r.sun.target.position.copy(i.position),r.sun.target.updateMatrixWorld(),r.sun.color.copy(a.sun),r.sun.intensity=Math.max(0,a.sunI)*(1-_)*ru,r.sun.castShadow=r.sun.intensity>.02,r.hemi.color.copy(a.hemiSky),r.hemi.groundColor.copy(a.hemiGround),r.hemi.intensity=a.hemiI*(1-_*.3)*ru,r.ambient.color.copy(a.amb),r.ambient.intensity=a.ambI*(1-_*.15)*ru,t.fog.color.copy(a.fog),t.fog.density=a.fogD+d.fogBoost,e.setClearColor(t.fog.color);let v=Eu(.06,-.06,g),y=Ou(p+s*Math.PI*2/au),b=h-y;Vl(b,c);let x=c.y/c.length(),S=(.5-.5*Math.cos(y))*Eu(-.02,.2,x)*v;r.moon.position.copy(c).multiplyScalar(.25),r.moon.intensity=S*ou*ru,r.moon.visible=S>.005,m.starOpacity=Eu(.03,-.13,g)*(1-.38*S),m.sunTheta=h,m.moonTheta=b,m.moonPhi=y,m.glowOpacity=a.glowO,m.glowScale=a.glowS,m.night=v,m.elevation=g,m.moonlight=S,n.update(m,o)}return h(0),{weather:d,get night(){return m.night},get elevation(){return m.elevation},update:function(e,t){f+=e,m.time=t,h(e)}}}function Eu(e,t,n){let r=Math.max(0,Math.min(1,(n-e)/(t-e)));return r*r*(3-2*r)}function Du(e){let t=Math.max(0,Math.min(1,e));return t*t*t*(t*(t*6-15)+10)}function Ou(e){let t=Math.PI*2;return(e%t+t)%t}function ku(){G.enabled=!1;let e=new El({antialias:!0,powerPreference:`high-performance`});return e.outputColorSpace=Be,e.shadowMap.enabled=!0,e.shadowMap.type=1,e.setSize(window.innerWidth,window.innerHeight),e.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.setClearColor(nu),e}function Au(e){let t=new Ha(uu.sun,uu.sunI*ru);e.add(t),e.add(t.target),t.castShadow=!0,t.shadow.mapSize.set(cu,cu),t.shadow.camera.left=-34,t.shadow.camera.right=su,t.shadow.camera.top=su,t.shadow.camera.bottom=-34,t.shadow.camera.near=5,t.shadow.camera.far=156.6,t.shadow.bias=-6e-4,t.shadow.normalBias=.09;let n=new Ha(11125488,0);e.add(n);let r=new Ta(uu.hemiSky,uu.hemiGround,uu.hemiI*ru);e.add(r);let i=new Ua(uu.amb,uu.ambI*ru);return e.add(i),{sun:t,moon:n,hemi:r,ambient:i}}var ju=34;function Mu(e,t,n){let r=document.createElement(`canvas`);r.width=r.height=19*ju;let i=r.getContext(`2d`);i.fillStyle=`#7a5c2c`,i.fillRect(0,0,r.width,r.height);for(let e=0;e<19;e++)for(let n=0;n<19;n++){if(!t[e][n])continue;let r=e*ju,a=n*ju,o=i.createRadialGradient(r+ju/2,a+ju/2,2,r+ju/2,a+ju/2,ju*.85);o.addColorStop(0,`rgba(176,143,86,0.95)`),o.addColorStop(1,`rgba(176,143,86,0)`),i.fillStyle=o,i.fillRect(r-ju*.4,a-ju*.4,ju*1.8,ju*1.8)}for(let e=0;e<26e3;e++){let e=Math.random()*r.width,t=Math.random()*r.height;i.fillStyle=`rgba(`+(95+Math.random()*75|0)+`,`+(70+Math.random()*60|0)+`,`+(26+Math.random()*34|0)+`,`+(.1+Math.random()*.22).toFixed(2)+`)`,i.fillRect(e,t,1+Math.random()*3,1+Math.random()*3)}for(let e=0;e<700;e++)i.save(),i.translate(Math.random()*r.width,Math.random()*r.height),i.rotate(Math.random()*Math.PI),i.fillStyle=`rgba(150,124,58,0.35)`,i.fillRect(-4,-1,8,2),i.restore();let a=new zi(r);a.anisotropy=n;let o=new q(new Yi(Ol,Ol),new J({map:a,roughness:1,metalness:0}));o.rotation.x=-Math.PI/2,o.position.y=.01,o.receiveShadow=!0,e.add(o)}var Nu=30,Pu=2;function Fu(e,t){let n={value:0},r=Lu(t),i=new J({map:r,side:2,alphaTest:.28,roughness:.92,metalness:0}),a=[`#include <begin_vertex>`,`#ifdef USE_INSTANCING`,`  vec3 iPos = instanceMatrix[3].xyz;`,`  float h = clamp(position.y, 0.0, 1.0);`,`  float bend = h * h;`,`  float phase = iPos.x * 0.55 + iPos.z * 0.42;`,`  float gust = 0.62 + 0.38 * sin(uTime * 0.13 + iPos.x * 0.035 + iPos.z * 0.021);`,`  float sway = sin(uTime * 1.05 + phase) * 0.20`,`             + sin(uTime * 2.60 + phase * 1.7) * 0.065`,`             + sin(uTime * 0.47 + phase * 0.5) * 0.10;`,`  transformed.x += sway * bend * gust;`,`  transformed.z += sway * 0.42 * bend * gust;`,`#endif`].join(`
`);function o(e){e.uniforms.uTime=n,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
uniform float uTime;`).replace(`#include <begin_vertex>`,a)}i.onBeforeCompile=o;let s=new ca({depthPacking:L,map:r,alphaTest:.28});s.onBeforeCompile=o;let c=new Yi(1,1,1,4);c.translate(0,.5,0);let l=Iu(e),u=new li(c,i,l.length*Pu);u.frustumCulled=!1,u.castShadow=!0,u.receiveShadow=!1,u.customDepthMaterial=s;let d=new on,f=new K,p=0;for(let e=0;e<l.length;e++){let t=l[e];f.setHSL(.23+Math.random()*.06,.34+Math.random()*.2,.62+Math.random()*.22);for(let e=0;e<Pu;e++)d.position.set(t.x,0,t.z),d.rotation.set(t.tx,t.r+Math.PI/Pu*e,t.tz),d.scale.set(t.w,t.h,1),d.updateMatrix(),u.setMatrixAt(p,d.matrix),u.setColorAt(p,f),p++}return u.instanceMatrix.needsUpdate=!0,u.instanceColor&&(u.instanceColor.needsUpdate=!0),{mesh:u,uTime:n}}function Iu(e){let t=[];for(let n=0;n<19;n++)for(let r=0;r<19;r++){if(e[n][r])continue;let i=Al(n,r);for(let e=0;e<Nu;e++)t.push({x:i.x+(Math.random()-.5)*Dl*1.02,z:i.z+(Math.random()-.5)*Dl*1.02,h:2.7+Math.random()*.85,w:1.5+Math.random()*.62,r:Math.random()*Math.PI,tx:(Math.random()-.5)*.16,tz:(Math.random()-.5)*.16})}return t}function Lu(e){let t=document.createElement(`canvas`);t.width=256,t.height=512;let n=t.getContext(`2d`),r=56.32,i=n.createLinearGradient(120,0,136,0);i.addColorStop(0,`#456a22`),i.addColorStop(.45,`#82ad42`),i.addColorStop(1,`#3d5f1d`),n.fillStyle=i,n.beginPath(),n.moveTo(120,510),n.lineTo(124.5,r),n.lineTo(131.5,r),n.lineTo(136,510),n.closePath(),n.fill();function a(e,t,r,i,a,o,s){let c=128+t*r,l=e-i+a,u=128+t*r*.3,d=e-i*.85,f=128+t*r*.72,p=e-i*.95,m=Math.max(8,r*.17);n.beginPath(),n.moveTo(128,e+m*.55),n.bezierCurveTo(u,d+m,f,p+m*.75,c,l),n.bezierCurveTo(f,p-m*.45,u,d-m*.65,128,e-m*.85),n.closePath();let h=n.createLinearGradient(128,e,c,l);h.addColorStop(0,o),h.addColorStop(1,s),n.fillStyle=h,n.fill(),n.strokeStyle=`rgba(238,255,206,0.20)`,n.lineWidth=1.4,n.beginPath(),n.moveTo(128,e),n.bezierCurveTo(u,d+m*.2,f,p+m*.1,c,l),n.stroke()}let o=[[`#3a651b`,`#7fb340`],[`#48782a`,`#93c04c`],[`#325718`,`#6ea033`]];for(let e=0;e<8;e++){let t=e/7;a(510-378.88*t-22,e%2==0?-1:1,Math.min(120,112*(1-t*.42)*(.85+Math.random()*.3)),42*(1-t*.3),58*(1-t*.4),o[e%3][0],o[e%3][1])}n.save(),n.translate(137,356.4),n.rotate(.22),n.fillStyle=`#a8bf5c`,n.beginPath(),n.ellipse(0,0,11,34,0,0,Math.PI*2),n.fill(),n.strokeStyle=`rgba(70,100,30,0.5)`,n.lineWidth=1;for(let e=-2;e<=2;e++)n.beginPath(),n.moveTo(e*4,-32),n.lineTo(e*4,32),n.stroke();n.strokeStyle=`#c9a05a`,n.lineWidth=2;for(let e=0;e<5;e++)n.beginPath(),n.moveTo(0,-32),n.quadraticCurveTo(4+e*3,-46,2+e*5,-58),n.stroke();n.restore(),n.strokeStyle=`#cbab6d`,n.lineWidth=2.2;for(let e=0;e<9;e++){let t=(e/8-.5)*1.25;n.beginPath(),n.moveTo(128,86.32),n.quadraticCurveTo(128+Math.sin(t)*24,54.32,128+Math.sin(t)*42,30.32),n.stroke()}let s=new zi(t);return s.anisotropy=e,s.minFilter=c,s}var Ru=Ol/2,zu=58,Bu=96,Vu=-43,Hu=7.5;function Uu(e,t,n){let r=new sn,i=[],a={value:0},o=[];qu(r,n),Ju(r,e,n),Zu(r,a,n);let s=td(n);return ed(r,a,s),nd(r,i,o,n),sd(r,i),cd(r,i,n),ud(r,e),dd(r,i,e),fd(r,i,t,s),r.traverse(function(e){if(!e.isMesh)return;e.receiveShadow=!0;let t=Math.abs(e.rotation.x+Math.PI/2)<.01;e.castShadow=!e.isInstancedMesh&&!t}),{group:r,obstacles:i,uTime:a,update:function(e){for(let t=0;t<o.length;t++)o[t](e)}}}function Wu(e,t,n,r){e.onBeforeCompile=function(e){e.uniforms.uTime=t,e.uniforms.uAmount={value:n},e.uniforms.uSpeed={value:r},e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
uniform float uTime;
...
`))}}function Gu(e,t){return Math.abs(e)<Ru+.8&&Math.abs(t)<Ru+.8}function Ku(e){return e>Vu-Hu*.75&&e<-37.375}function qu(t,n){let r=document.createElement(`canvas`);r.width=r.height=512;let i=r.getContext(`2d`);i.fillStyle=`#a68d54`,i.fillRect(0,0,512,512);for(let e=0;e<512;e+=16)i.fillStyle=`rgba(128,103,52,0.55)`,i.fillRect(0,e,512,6),i.fillStyle=`rgba(212,193,136,0.42)`,i.fillRect(0,e+7,512,4);for(let e=0;e<9e3;e++){let e=Math.random()*512,t=Math.floor(512/16*Math.random())*16+2+Math.random()*10;i.fillStyle=`rgba(`+(196+Math.random()*45|0)+`,`+(176+Math.random()*45|0)+`,`+(110+Math.random()*50|0)+`,`+(.3+Math.random()*.45).toFixed(2)+`)`,i.fillRect(e,t,1+Math.random()*2,2+Math.random()*4)}for(let e=0;e<260;e++){let e=Math.random()*512,t=Math.random()*512,n=4+Math.random()*22,r=i.createRadialGradient(e,t,0,e,t,n);r.addColorStop(0,`rgba(126,101,56,0.42)`),r.addColorStop(1,`rgba(126,101,56,0)`),i.fillStyle=r,i.beginPath(),i.arc(e,t,n,0,Math.PI*2),i.fill()}let a=new zi(r);a.wrapS=a.wrapT=e,a.repeat.set(22,22),a.anisotropy=n;let o=new q(new Yi(340,340),new J({map:a,roughness:1,metalness:0}));o.rotation.x=-Math.PI/2,t.add(o)}function Ju(t,n,r){let i=Yu(r,!1);i.wrapT=e,i.repeat.set(1,14);let a=new J({map:i,roughness:1,transparent:!0,depthWrite:!1}),o=new q(new Yi(Hu,230),a);o.rotation.x=-Math.PI/2,o.position.set(Vu,.02,0),o.renderOrder=1,t.add(o);let s=-44.5,c=n.x+.6,l=Yu(r,!0);l.wrapS=e,l.repeat.set(2.2,1);let u=new q(new Yi(c-s,5.2),new J({map:l,roughness:1,transparent:!0,depthWrite:!1}));u.rotation.x=-Math.PI/2,u.position.set((s+c)/2,.03,n.z),u.renderOrder=2,t.add(u)}function Yu(e,n){let r=document.createElement(`canvas`);r.width=128,r.height=512;let i=r.getContext(`2d`);i.fillStyle=`#a98d5e`,i.fillRect(0,0,128,512);for(let e=0;e<2;e++){let t=e===0?34:94,n=i.createLinearGradient(t-16,0,t+16,0);n.addColorStop(0,`rgba(198,174,126,0)`),n.addColorStop(.5,`rgba(198,174,126,0.75)`),n.addColorStop(1,`rgba(198,174,126,0)`),i.fillStyle=n,i.fillRect(t-16,0,32,512)}i.fillStyle=`rgba(122,116,62,0.30)`,i.fillRect(58,0,12,512);for(let e=0;e<7e3;e++)i.fillStyle=`rgba(`+(90+Math.random()*110|0)+`,`+(78+Math.random()*90|0)+`,`+(50+Math.random()*60|0)+`,`+(.1+Math.random()*.3).toFixed(2)+`)`,i.fillRect(Math.random()*128,Math.random()*512,1+Math.random()*2,1+Math.random()*2);let a=i.createLinearGradient(0,0,128,0);a.addColorStop(0,`rgba(0,0,0,1)`),a.addColorStop(.16,`rgba(0,0,0,0)`),a.addColorStop(.84,`rgba(0,0,0,0)`),a.addColorStop(1,`rgba(0,0,0,1)`),i.globalCompositeOperation=`destination-out`,i.fillStyle=a,i.fillRect(0,0,128,512);let o=r;if(n){o=document.createElement(`canvas`),o.width=512,o.height=128;let e=o.getContext(`2d`);e.translate(0,128),e.rotate(-Math.PI/2),e.drawImage(r,0,0)}let s=new zi(o);return s.wrapS=s.wrapT=t,s.anisotropy=e,s}var Xu=17e3;function Zu(e,t,n){let r=new Yi(1,1);r.translate(0,.5,0);let i=new J({map:Qu(n),side:2,alphaTest:.34,roughness:.95,metalness:0});Wu(i,t,.13,1.55);let a=new li(r,i,Xu);a.frustumCulled=!1;let o=new on,s=new K,c=0,l=0;for(;c<Xu&&l++<Xu*8;){let e=Math.random()*Math.PI*2,t=Math.sqrt(Math.random())*zu,n=Math.cos(e)*t,r=Math.sin(e)*t;if(Gu(n,r)||Ku(n))continue;o.position.set(n,0,r),o.rotation.set(0,Math.random()*Math.PI,0);let i=.2+Math.random()*.42;o.scale.set(i*(1+Math.random()*.5),i,1),o.updateMatrix(),a.setMatrixAt(c,o.matrix);let l=Math.random()>.22;s.setHSL(l?.13+Math.random()*.04:.24+Math.random()*.05,.26+Math.random()*.2,.6+Math.random()*.28),a.setColorAt(c,s),c++}a.count=c,a.instanceMatrix.needsUpdate=!0,a.instanceColor&&(a.instanceColor.needsUpdate=!0),e.add(a)}function Qu(e){let t=document.createElement(`canvas`);t.width=128,t.height=128;let n=t.getContext(`2d`);for(let e=0;e<54;e++){let e=(Math.random()-.5)*46,t=128/2+(Math.random()-.5)*52,r=16+Math.random()*62;n.strokeStyle=`rgba(`+(150+Math.random()*80|0)+`,`+(140+Math.random()*70|0)+`,`+(72+Math.random()*60|0)+`,0.95)`,n.lineWidth=1+Math.random()*1.5,n.beginPath(),n.moveTo(t,127),n.quadraticCurveTo(t+e*.35,(127+r)/2,t+e,r),n.stroke(),Math.random()>.72&&(n.fillStyle=`rgba(214,196,132,0.9)`,n.beginPath(),n.ellipse(t+e,r,1.8,4.5,e*.01,0,Math.PI*2),n.fill())}for(let e=0;e<2;e++){if(Math.random()>.5)continue;let e=128/2+(Math.random()-.5)*40,t=16+Math.random()*34;n.fillStyle=Math.random()>.5?`rgba(226,208,110,0.95)`:`rgba(206,150,178,0.9)`;for(let r=0;r<6;r++){let i=r/6*Math.PI*2;n.beginPath(),n.ellipse(e+Math.cos(i)*3.2,t+Math.sin(i)*3.2,2.4,2.4,0,0,Math.PI*2),n.fill()}}let r=new zi(t);return r.anisotropy=e,r}var $u=240;function ed(e,t,n){let r=new Yi(1,1);r.translate(0,.5,0);let i=new J({map:n,side:2,alphaTest:.4,roughness:1,metalness:0});Wu(i,t,.06,.5);let a=new li(r,i,480);a.frustumCulled=!1;let o=new on,s=new K,c=0;for(let e=0;e<$u;e++){let t=e/$u*Math.PI*2+(Math.random()-.5)*.06,n=Bu+(Math.random()-.5)*22,r=Math.cos(t)*n,i=Math.sin(t)*n,l=7+Math.random()*6,u=Math.random()*Math.PI;s.setHSL(.26+Math.random()*.05,.22+Math.random()*.14,.3+Math.random()*.16);for(let e=0;e<2;e++)o.position.set(r,0,i),o.rotation.set(0,u+e*Math.PI/2,0),o.scale.set(l*.8,l,1),o.updateMatrix(),a.setMatrixAt(c,o.matrix),a.setColorAt(c,s),c++}a.instanceMatrix.needsUpdate=!0,a.instanceColor&&(a.instanceColor.needsUpdate=!0),e.add(a)}function td(e){let t=document.createElement(`canvas`);t.width=128,t.height=160;let n=t.getContext(`2d`);n.fillStyle=`#5a4326`,n.fillRect(128/2-5,88,10,72);for(let e=0;e<90;e++){let e=Math.random()*Math.PI*2,t=Math.random()**.55,r=128/2+Math.cos(e)*t*52,i=160*.36+Math.sin(e)*t*44,a=8+Math.random()*20,o=.55+(1-t)*.35;n.fillStyle=`rgba(`+(60*o|0)+`,`+(95*o|0)+`,`+(48*o|0)+`,0.95)`,n.beginPath(),n.arc(r,i,a,0,Math.PI*2),n.fill()}let r=new zi(t);return r.anisotropy=e,r}var Z={x:-53,z:-37,w:15,d:10,wall:5.2,ridge:3.4,turn:.22};function nd(e,t,n,r){let i=new sn;i.position.set(Z.x,0,Z.z),i.rotation.y=Z.turn;let a=new J({map:ad(r),roughness:.95,metalness:0}),o=new J({map:od(r),side:2,roughness:.7,metalness:.1}),s=new q(new Ui(Z.w,Z.wall,Z.d),a);s.position.y=Z.wall/2,i.add(s);let c=Math.sqrt(Z.d*Z.d/4+Z.ridge*Z.ridge),l=Math.atan2(Z.d/2,Z.ridge);for(let e=-1;e<=1;e+=2){let t=new q(new Yi(Z.w+1.2,c+.7),o);t.rotation.x=-e*l,t.position.set(0,Z.wall+Z.ridge/2,e*Z.d/4),i.add(t)}let u=new J({map:a.map,side:2,roughness:.95});for(let e=-1;e<=1;e+=2){let t=new ur,n=e*Z.w/2;t.setAttribute(`position`,new Yn(new Float32Array([n,Z.wall,-Z.d/2,n,Z.wall,Z.d/2,n,Z.wall+Z.ridge,0]),3)),t.setAttribute(`uv`,new Yn(new Float32Array([0,0,1,0,.5,1]),2)),t.computeVertexNormals(),i.add(new q(t,u))}let d=new J({color:7031338,roughness:.95}),f=new q(new Ui(5.4,4,.22),d);f.position.set(-2.2,2,Z.d/2+.06),i.add(f);let p=new q(new Ui(9.5,.22,.3),d);p.position.set(-1.4,4.25,Z.d/2+.1),i.add(p);let m=[],h=[];for(let e=0;e<2;e++){let t=new q(new Yi(1.5,1.2),new Br({color:2828838}));t.position.set(3.2+e*2.6,3.3,Z.d/2+.07),i.add(t),m.push(t);let n=id(16762736,5);n.position.copy(t.position),n.position.z+=.3,i.add(n),h.push(n)}let g=id(16765578,7);g.position.set(-2.2,4.7,Z.d/2+.5),i.add(g),h.push(g),n.push(function(e){let t=e*e;for(let e=0;e<m.length;e++)m[e].material.color.setRGB(.17+t*.83,.16+t*.62,.14+t*.26);for(let e=0;e<h.length;e++)h[e].material.opacity=t*.6}),e.add(i),t.push({x:Z.x,z:Z.z,hw:Z.w/2+.4,hd:Z.d/2+.4,turn:Z.turn})}var rd=null;function id(e,t){if(!rd){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);n.addColorStop(0,`rgba(255,255,255,0.9)`),n.addColorStop(.3,`rgba(255,255,255,0.28)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),rd=new zi(e)}let n=new Ar(new gr({map:rd,color:e,transparent:!0,opacity:0,depthWrite:!1,blending:2}));return n.scale.set(t,t,1),n}function ad(t){let n=document.createElement(`canvas`);n.width=256,n.height=256;let r=n.getContext(`2d`);r.fillStyle=`#7d3c2c`,r.fillRect(0,0,256,256);for(let e=0;e<256;e+=16){let t=.82+Math.random()*.36;r.fillStyle=`rgb(`+(125*t|0)+`,`+(60*t|0)+`,`+(44*t|0)+`)`,r.fillRect(e,0,15,256),r.fillStyle=`rgba(40,18,12,0.55)`,r.fillRect(e+15,0,1,256)}for(let e=0;e<2600;e++)r.fillStyle=`rgba(`+(170+Math.random()*60|0)+`,`+(140+Math.random()*50|0)+`,`+(120+Math.random()*40|0)+`,`+(.04+Math.random()*.12).toFixed(2)+`)`,r.fillRect(Math.random()*256,Math.random()*256,1+Math.random()*5,1+Math.random()*3);let i=new zi(n);return i.wrapS=i.wrapT=e,i.repeat.set(3,1),i.anisotropy=t,i}function od(t){let n=document.createElement(`canvas`);n.width=n.height=128;let r=n.getContext(`2d`);r.fillStyle=`#4c4a45`,r.fillRect(0,0,128,128);for(let e=0;e<128;e+=8)r.fillStyle=`rgba(96,94,88,0.7)`,r.fillRect(e,0,3,128),r.fillStyle=`rgba(30,29,27,0.5)`,r.fillRect(e+5,0,2,128);for(let e=0;e<400;e++)r.fillStyle=`rgba(122,86,54,`+(.05+Math.random()*.2).toFixed(2)+`)`,r.fillRect(Math.random()*128,Math.random()*128,2+Math.random()*6,2+Math.random()*4);let i=new zi(n);return i.wrapS=i.wrapT=e,i.repeat.set(8,2),i.anisotropy=t,i}function sd(e,t){let n=new sn;n.position.set(-35.5,0,-25.8),n.rotation.y=-.55;let r=new J({color:10367776,roughness:.62,metalness:.25}),i=new J({color:1842206,roughness:.85}),a=new J({color:7303542,roughness:.5,metalness:.4}),o=new q(new Ui(1.25,.95,2.5),r);o.position.set(0,1.15,.75),n.add(o);let s=new q(new Ui(1.05,.7,3.4),r);s.position.set(0,.72,.1),n.add(s);let c=new q(new Ui(.85,.22,.75),i);c.position.set(0,1.42,-.95),n.add(c);let l=new q(new Ui(.85,.62,.18),i);l.position.set(0,1.72,-1.3),n.add(l);let u=new q(new Gi(.06,.06,.85,8),a);u.position.set(0,1.72,-.32),u.rotation.x=.42,n.add(u);let d=new q(new Zi(.28,.045,6,16),i);d.position.set(0,2.08,-.16),d.rotation.x=Math.PI/2-.42,n.add(d);let f=new q(new Gi(.075,.09,1.5,8),a);f.position.set(.42,2.05,1.5),n.add(f);let p=new Gi(.92,.92,.42,16),m=new Gi(.5,.5,.3,14),h=new Gi(.36,.36,.44,12);for(let e=-1;e<=1;e+=2){let t=new q(p,i);t.position.set(e*.92,.92,-1),t.rotation.z=Math.PI/2,n.add(t);let o=new q(h,a);o.position.set(e*.95,.92,-1),o.rotation.z=Math.PI/2,n.add(o);let s=new q(m,i);s.position.set(e*.72,.5,1.6),s.rotation.z=Math.PI/2,n.add(s);let c=new q(new Ui(.16,1.05,2.1),r);c.position.set(e*.86,1.35,-1),n.add(c)}e.add(n),t.push({x:n.position.x,z:n.position.z,r:2.3})}function cd(e,t,n){let r=new J({map:ld(n),roughness:1,metalness:0}),i=new Gi(.95,.95,1.5,14),a=[[-50.5,-30.5,0],[-50.5,-28.4,0],[-50.5,-26.3,0],[-50.5,-29.4,1],[-50.5,-27.3,1],[-34.5,24.5,0],[-34.5,22.4,0]];for(let n=0;n<a.length;n++){let o=a[n],s=new q(i,r);s.position.set(o[0],.95+o[2]*1.7,o[1]),s.rotation.z=Math.PI/2,s.rotation.y=Math.random()*.2,e.add(s),o[2]===0&&t.push({x:o[0],z:o[1],r:1.35})}}function ld(t){let n=document.createElement(`canvas`);n.width=n.height=128;let r=n.getContext(`2d`);r.fillStyle=`#c6a961`,r.fillRect(0,0,128,128);for(let e=0;e<2600;e++){let e=Math.random()*128,t=Math.random()*128;r.strokeStyle=`rgba(`+(150+Math.random()*90|0)+`,`+(128+Math.random()*80|0)+`,`+(60+Math.random()*60|0)+`,`+(.2+Math.random()*.5).toFixed(2)+`)`,r.lineWidth=1,r.beginPath(),r.moveTo(e,t),r.lineTo(e+(Math.random()-.5)*14,t+(Math.random()-.5)*4),r.stroke()}let i=new zi(n);return i.wrapS=i.wrapT=e,i.repeat.set(3,2),i.anisotropy=t,i}function ud(e,t){let n=new J({color:6968886,roughness:1}),r=-38.05,i=new li(new Ui(.14,1.4,.14),n,63),a=new on,o=0;for(let e=-96;e<=96;e+=3.1)Math.abs(e-t.z)<4||(a.position.set(r+(Math.random()-.5)*.12,.7,e),a.rotation.set((Math.random()-.5)*.06,Math.random()*.3,(Math.random()-.5)*.09),a.scale.set(1,.9+Math.random()*.25,1),a.updateMatrix(),i.setMatrixAt(o++,a.matrix));i.count=o,i.instanceMatrix.needsUpdate=!0,e.add(i);let s=new J({color:4867648,roughness:.8,metalness:.3}),c=[[-96,t.z-4.2],[t.z+4.2,96]];for(let t=0;t<c.length;t++){let n=c[t][1]-c[t][0],i=(c[t][0]+c[t][1])/2;for(let t=0;t<2;t++){let a=new q(new Ui(.035,.035,n),s);a.position.set(r,.72+t*.42,i),e.add(a)}}}function dd(e,t,n){let r=new sn;r.position.set(n.x-2.6,0,n.z+7.5),r.rotation.y=-1.1;let i=new J({color:6967859,roughness:1}),a=new J({color:8219722,roughness:1}),o=new J({color:5071984,roughness:1}),s=new J({color:11901532,roughness:1}),c=new q(new Ui(.13,2.5,.13),i);c.position.y=1.25,r.add(c);let l=new q(new Ui(1.9,.11,.11),i);l.position.y=1.85,l.rotation.z=.06,r.add(l);let u=new q(new Ui(.62,.85,.34),o);u.position.y=1.62,r.add(u);for(let e=-1;e<=1;e+=2){let t=new q(new Ui(.62,.2,.2),o);t.position.set(e*.62,1.85+e*.02,0),r.add(t)}let d=new q(new Xi(.24,12,10),a);d.position.y=2.28,d.scale.set(1,1.15,.95),r.add(d);let f=new q(new Gi(.42,.42,.04,14),s);f.position.y=2.48,f.rotation.z=.12,r.add(f);let p=new q(new Gi(.2,.24,.28,14),s);p.position.set(.03,2.62,0),p.rotation.z=.12,r.add(p),e.add(r),t.push({x:r.position.x,z:r.position.z,r:.5})}function fd(e,t,n,r){let i=n.x+9.5,a=n.z+4.5,o=new sn;o.position.set(i+2.6,0,a-2.4);let s=new J({map:r,side:2,alphaTest:.4,roughness:1}),c=new Yi(1,1);c.translate(0,.5,0);for(let e=0;e<3;e++){let t=new q(c,s);t.scale.set(9.5,12,1),t.rotation.y=e*Math.PI/3,o.add(t)}e.add(o),t.push({x:o.position.x,z:o.position.z,r:.7});let l=new J({color:9071169,roughness:1}),u=new sn;u.position.set(i,0,a),u.rotation.y=-.9;let d=new q(new Ui(2.2,.09,.5),l);d.position.y=.46,u.add(d);let f=new q(new Ui(2.2,.32,.08),l);f.position.set(0,.82,-.22),f.rotation.x=-.16,u.add(f);for(let e=-1;e<=1;e+=2){let t=new q(new Ui(.1,.46,.46),l);t.position.set(e*.9,.23,0),u.add(t);let n=new q(new Ui(.09,.55,.09),l);n.position.set(e*.9,.7,-.2),u.add(n)}e.add(u),t.push({x:i,z:a,r:1.15})}var pd=11,md=9.5,hd=3,gd=11,_d=2.05,vd=1.78;function yd(e,t,n,r,i){let a=new sn,o=[],s=bd(e,t,n,r),c=new J({color:5916201,roughness:1}),l=new J({color:3025702,roughness:.75,metalness:.35}),u=new Gi(.055,.075,_d,7),d=new Ui(.42,.05,.05),f=new Ki(.17,.14,6),p=new Ui(.19,.24,.19),m=xd();for(let e=0;e<s.length;e++){let t=s[e],n=new q(u,c);n.position.set(t.x,_d/2,t.z),n.rotation.y=Math.random()*1.5,n.rotation.z=(Math.random()-.5)*.05,a.add(n);let r=new q(d,l);r.position.set(t.x-t.dx*.19,1.9899999999999998,t.z-t.dz*.19),r.rotation.y=Math.atan2(t.dx,t.dz),a.add(r);let i=t.x-t.dx*.38,h=t.z-t.dz*.38,g=new q(p,new Br({color:2828065}));g.position.set(i,1.8299999999999998,h),a.add(g);let _=new q(f,l);_.position.set(i,2.02,h),a.add(_);let v=new Ar(new gr({map:m,color:16760434,transparent:!0,opacity:0,depthWrite:!1,blending:2}));v.scale.set(2.6,2.6,1),v.position.copy(g.position),a.add(v),o.push({x:i,z:h,y:1.8299999999999998,glass:g,glow:v,phase:Math.random()*6.28,rate:.7+Math.random()*.9,d2:0})}let h=[];for(let e=0;e<hd;e++){let e=new za(16758629,0,gd,1);e.visible=!1,a.add(e),h.push(e)}let g=o.map(function(e){return{x:e.x,z:e.z,r:.3}});if(i)for(let e=0;e<i.length;e++)o.push(i[e]);return{group:a,obstacles:g,update:function(e,t,n){let r=Sd(.12,.75,t);for(let t=0;t<o.length;t++){let i=o[t];i.level=r*(.82+.18*Math.sin(e*i.rate*3.1+i.phase)+.08*Math.sin(e*i.rate*7.7+i.phase*2.3)),i.glass.material.color.setRGB(.17+i.level*.83,.15+i.level*.58,.13+i.level*.22),i.glow.material.opacity=i.level*.8,i.glow.visible=i.level>.01;let a=n.x-i.x,s=n.z-i.z;i.d2=a*a+s*s}if(r<.01){for(let e=0;e<h.length;e++)h[e].visible=!1;return}for(let e=0;e<hd&&e<o.length;e++){let t=e;for(let n=e+1;n<o.length;n++)o[n].d2<o[t].d2&&(t=n);let n=o[e];o[e]=o[t],o[t]=n;let r=o[e],i=h[e];i.position.set(r.x,r.y,r.z),i.intensity=r.level*1.15*ru*vd,i.visible=r.d2<121*1.6}}}}function bd(e,t,n,r){let i=[];function a(t,n){if(t<0||n<0||t>=19||n>=19||!e[t][n])return!1;let r=[[1,0],[-1,0],[0,1],[0,-1]].filter(function(r){let i=t+r[0],a=n+r[1];return i<0||a<0||i>=19||a>=19||!e[i][a]});if(!r.length)return!1;let a=Al(t,n),o=r[Math.random()*r.length|0],s=a.x+o[0]*Dl*.33,c=a.z+o[1]*Dl*.33;for(let e=0;e<i.length;e++){let t=i[e].x-s,n=i[e].z-c;if(t*t+n*n<md*md)return!1}return i.push({x:s,z:c,dx:o[0],dz:o[1]}),!0}function o(t){for(let n=0;n<19;n++)for(let r=0;r<19;r++){if(!e[n][r])continue;let i=Al(n,r),o=i.x-t.x,s=i.z-t.z;if(o*o+s*s<3.2*3.2*2.2&&a(n,r))return}}o(n),o(r);for(let e=0;e<t.length&&i.length<pd;e++)a(t[e][0],t[e][1]);return i}function xd(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,`rgba(255,246,224,0.95)`),n.addColorStop(.25,`rgba(255,206,140,0.42)`),n.addColorStop(1,`rgba(255,190,110,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new zi(e)}function Sd(e,t,n){let r=Math.max(0,Math.min(1,(n-e)/(t-e)));return r*r*(3-2*r)}var Cd=kl-.6,wd=512,Td=.5,Ed=.035,Dd=[{x:-1.15,z:.55,r:.62,h:1.05,tilt:.16},{x:-.05,z:1.7,r:.38,h:.52,tilt:.35},{x:1.7,z:-.95,r:.3,h:.4,tilt:.22}],Od={x:2.1,z:1.75},kd={x:-2.35,z:-2.05};function Ad(e){let t=new sn,n=[],r=jd(e);t.add(r.mesh);let i=new J({color:7039072,roughness:.98,flatShading:!0});for(let e=0;e<Dd.length;e++){let r=Dd[e],a=new q(Md(new Ji(r.r,1),r.r*.2),i);a.position.set(r.x,r.h*.4,r.z),a.scale.set(1,r.h/(r.r*2),.85+Math.random()*.3),a.rotation.set(r.tilt,Math.random()*3.14,r.tilt*.6),a.castShadow=!0,a.receiveShadow=!0,t.add(a),n.push({x:r.x,z:r.z,r:r.r*.9})}let a=Id(t);n.push({x:Od.x,z:Od.z,r:.45});let o=Rd(t);n.push({x:kd.x,z:kd.z,r:.34});let s=4;return{group:t,obstacles:n,flame:o.flame,inside:function(e){let t=e.x,n=e.z;return t*t+n*n<Cd*Cd},update:function(e,t,n,i){let o=n.x-Od.x,c=n.z-Od.z,l=Math.sqrt(o*o+c*c);r.update(e,n),a.update(e,t),s-=e,s<=0&&(s=(l<4?2.4:7)+Math.random()*3,a.drip(),i&&i(l))}}}function jd(e){let t=document.createElement(`canvas`);t.width=t.height=wd,Fd(t.getContext(`2d`));let n=document.createElement(`canvas`);n.width=n.height=wd;let r=n.getContext(`2d`);r.drawImage(t,0,0);let i=new zi(n);i.anisotropy=e;let a=new q(new Wi(Cd,64),new J({map:i,roughness:1,metalness:0}));a.rotation.x=-Math.PI/2,a.position.y=.03,a.receiveShadow=!0;let o=Td,s=!1,c=1e9,l=1e9;return{mesh:a,update:function(e,n){if(n.x*n.x+n.z*n.z<Cd*Cd){let e=n.x-c,t=n.z-l;e*e+t*t>.11&&(c=n.x,l=n.z,Pd(r,n.x,n.z),s=!0)}o-=e,o<=0?(o=Td,s&&(r.globalAlpha=Ed,r.drawImage(t,0,0),r.globalAlpha=1,i.needsUpdate=!0)):s&&(i.needsUpdate=!0)}}}function Md(e,t){let n=e.attributes.position;for(let e=0;e<n.count;e++)n.setXYZ(e,n.getX(e)+(Math.random()-.5)*t,n.getY(e)+(Math.random()-.5)*t,n.getZ(e)+(Math.random()-.5)*t);return e.computeVertexNormals(),e}function Nd(e,t){return[(.5+e/(2*Cd))*wd,(.5+t/(2*Cd))*wd]}function Pd(e,t,n){let r=Nd(t,n),i=wd*.026,a=e.createRadialGradient(r[0],r[1],0,r[0],r[1],i);a.addColorStop(0,`rgba(120,104,74,0.34)`),a.addColorStop(.6,`rgba(133,116,84,0.16)`),a.addColorStop(1,`rgba(133,116,84,0)`),e.fillStyle=a,e.beginPath(),e.arc(r[0],r[1],i,0,Math.PI*2),e.fill()}function Fd(e){e.fillStyle=`#9b8f70`,e.fillRect(0,0,wd,wd);for(let t=0;t<3e4;t++){let t=118+Math.random()*80;e.fillStyle=`rgba(`+(t|0)+`,`+(t-10|0)+`,`+(t-40|0)+`,0.34)`,e.fillRect(Math.random()*wd,Math.random()*wd,1.8,1.8)}let t=Dd.map(function(e){let t=Nd(e.x,e.z);return{x:t[0],y:t[1],r:e.r/(2*Cd)*wd*2.1}}),n=Nd(Od.x,Od.z);t.push({x:n[0],y:n[1],r:.5/(2*Cd)*wd*2});for(let n=0;n<t.length;n++){let r=t[n],i=e.createRadialGradient(r.x,r.y,r.r*.3,r.x,r.y,r.r*1.05);i.addColorStop(0,`rgba(74,92,44,0.62)`),i.addColorStop(1,`rgba(74,92,44,0)`),e.fillStyle=i,e.beginPath(),e.arc(r.x,r.y,r.r*1.05,0,Math.PI*2),e.fill()}function r(t){e.lineWidth=3.2,e.strokeStyle=`rgba(84,72,48,0.32)`,t(0,1.6),e.lineWidth=2.2,e.strokeStyle=`rgba(206,196,166,0.42)`,t(0,-1)}e.save();let i=new Path2D;i.rect(0,0,wd,wd);for(let e=0;e<t.length;e++)i.moveTo(t[e].x+t[e].r,t[e].y),i.arc(t[e].x,t[e].y,t[e].r,0,Math.PI*2);e.clip(i,`evenodd`);let a=wd/46;for(let t=a*.5;t<wd;t+=a)r(function(n,r){e.beginPath();for(let i=0;i<=wd;i+=16){let a=Math.sin(i*.021+t*.05)*2.2;i===0?e.moveTo(i+n,t+a+r):e.lineTo(i+n,t+a+r)}e.stroke()});e.restore();for(let n=0;n<t.length;n++){let i=t[n];for(let t=0;t<4;t++){let n=i.r*(1.16+t*.3);r(function(t,r){e.beginPath(),e.arc(i.x+t,i.y+r,n,0,Math.PI*2),e.stroke()})}}}function Id(e){let t=new J({color:6512986,roughness:.98,flatShading:!0}),n=new q(new Gi(.44,.34,.42,10),t);n.position.set(Od.x,.21,Od.z),n.castShadow=!0,n.receiveShadow=!0,e.add(n);let r=new q(new Wi(.37,24),new J({color:1780268,roughness:.04,metalness:.75}));r.rotation.x=-Math.PI/2,r.position.set(Od.x,.375,Od.z),e.add(r);let i=new J({color:9341766,roughness:.85}),a=new q(new Gi(.045,.05,.86,7),i);a.position.set(Od.x+.52,.43,Od.z+.34),a.castShadow=!0,e.add(a);let o=new U(Od.x+.52,.8,Od.z+.34),s=new U(Od.x+.04,.64,Od.z+.02),c=new U().subVectors(s,o),l=new q(new Gi(.032,.032,c.length(),7),i);l.position.copy(o).addScaledVector(c,.5),l.quaternion.setFromUnitVectors(new U(0,1,0),c.clone().normalize()),l.castShadow=!0,e.add(l);let u=Ld(),d=[];for(let t=0;t<3;t++){let t=new q(new Yi(.7,.7),new Br({map:u,transparent:!0,opacity:0,depthWrite:!1}));t.rotation.x=-Math.PI/2,t.position.set(Od.x,.379,Od.z),t.visible=!1,e.add(t),d.push({mesh:t,life:0})}let f=new q(new Xi(.018,6,5),new J({color:12374744,roughness:.1,metalness:.4}));f.visible=!1,e.add(f);let p=0;return{drip:function(){f.visible=!0,p=.7},update:function(e,t){if(f.visible&&(p-=e*2.4,f.position.set(Od.x+.04,p,Od.z+.02),p<=.39)){f.visible=!1;for(let e=0;e<d.length;e++)if(d[e].life<=0){d[e].life=1;break}}for(let t=0;t<d.length;t++){let n=d[t];if(n.life<=0){n.mesh.visible=!1;continue}n.life-=e*.55;let r=1-n.life;n.mesh.visible=!0,n.mesh.scale.setScalar(.12+r*.9),n.mesh.material.opacity=Math.max(0,n.life)*.5}}}}function Ld(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`);return t.strokeStyle=`rgba(210,230,235,0.9)`,t.lineWidth=3,t.beginPath(),t.arc(32,32,26,0,Math.PI*2),t.stroke(),t.strokeStyle=`rgba(210,230,235,0.35)`,t.lineWidth=2,t.beginPath(),t.arc(32,32,19,0,Math.PI*2),t.stroke(),new zi(e)}function Rd(e){let t=new J({color:8749946,roughness:.95,flatShading:!0}),n=[[new Gi(.34,.4,.16,8),.08],[new Gi(.11,.13,.72,8),.52],[new Gi(.28,.2,.1,8),.93]];for(let r=0;r<n.length;r++){let i=new q(n[r][0],t);i.position.set(kd.x,n[r][1],kd.z),i.castShadow=!0,i.receiveShadow=!0,e.add(i)}let r=new q(new Ui(.34,.34,.34),t);r.position.set(kd.x,1.15,kd.z),r.rotation.y=.4,r.castShadow=!0,e.add(r);let i=new q(new Ki(.4,.26,6),t);i.position.set(kd.x,1.44,kd.z),i.rotation.y=.4,i.castShadow=!0,e.add(i);let a=new q(new Xi(.075,8,6),t);a.position.set(kd.x,1.6,kd.z),e.add(a);let o=new q(new Yi(.2,.22),new Br({color:2828065,side:2}));o.position.set(kd.x+Math.sin(.4)*.175,1.15,kd.z+Math.cos(.4)*.175),o.rotation.y=.4,e.add(o);let s=new Ar(new gr({map:zd(),color:16763274,transparent:!0,opacity:0,depthWrite:!1,blending:2}));return s.scale.set(2.4,2.4,1),s.position.set(kd.x,1.15,kd.z),e.add(s),{flame:{x:kd.x,z:kd.z,y:1.15,glass:o,glow:s,phase:Math.random()*6.28,rate:.7+Math.random()*.9,d2:0}}}function zd(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,`rgba(255,246,224,0.95)`),n.addColorStop(.25,`rgba(255,206,140,0.42)`),n.addColorStop(1,`rgba(255,190,110,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new zi(e)}var Bd=[{kind:`deer`,count:2,w:2,h:1.65,path:!0,speed:2.9,notice:22,spook:7,watch:[2.4,4.5],rest:[45,110],voice:`deer`},{kind:`turkey`,count:2,w:1.05,h:1,path:!0,speed:2.2,notice:17,spook:5.5,watch:[2,3.8],rest:[40,95],voice:`turkey`},{kind:`raccoon`,count:2,w:.9,h:.62,path:!1,speed:2.2,notice:14,spook:4.2,watch:[1.8,3.4],rest:[35,90],voice:`chitter`},{kind:`rabbit`,count:2,w:.58,h:.52,path:!1,speed:3.3,notice:13,spook:4.6,watch:[1.4,2.8],rest:[30,80],voice:null},{kind:`mouse`,count:3,w:.3,h:.2,path:!1,speed:2.7,notice:8,spook:2.2,watch:[.9,1.8],rest:[22,60],voice:null}],Vd=21;function Hd(e,t){let n=new sn,r=Ud(e),i=Qd(t),a=[];for(let e=0;e<Bd.length;e++){let t=Bd[e];for(let e=0;e<t.count;e++)a.push(qd(n,t,i[t.kind],r))}let o=[Jd(n,i,r),Jd(n,i,r)],s=[Yd(n,i,r),Yd(n,i,r)],c=Xd(n,i,r),l=[Zd(n,i),Zd(n,i),Zd(n,i)],u=new U,d=new U,f=!1;return{group:n,danger:0,buzz:0,update:function(e,t,n,r,i){f||=(u.copy(n),!0),d.subVectors(n,u).divideScalar(Math.max(e,1e-4)),u.copy(n);let p=d.length();for(let o=0;o<a.length;o++)a[o].update(e,t,n,r,i);let m=0,h=0;for(let r=0;r<o.length;r++)m=Math.max(m,o[r].update(e,t,n,d,p,i));for(let r=0;r<s.length;r++)m=Math.max(m,s[r].update(e,t,n,d,p,i)),h=Math.max(h,s[r].buzz);m=Math.max(m,c.update(e,t,n)),this.danger=m,this.buzz=h;for(let a=0;a<l.length;a++)l[a].update(e,t,n,r,i)}}}function Ud(e){function t(t,n){return t>=0&&n>=0&&t<19&&n<19&&e[t][n]}function n(e,t){return[Math.round(e/Dl+18/2),Math.round(t/Dl+18/2)]}let r=[[1,0],[-1,0],[0,1],[0,-1]];return{open:t,cellOf:n,randomOpen:function(e,n,r){for(let i=0;i<160;i++){let i=1+(Math.random()*17|0),a=1+(Math.random()*17|0);if(!t(i,a)||Math.abs(i-9)<=1&&Math.abs(a-9)<=1)continue;let o=Al(i,a),s=Math.hypot(o.x-e.x,o.z-e.z);if(!(s<n||s>r))return{x:o.x,z:o.z,fx:i,fy:a}}return null},randomEdge:function(e,n,i){for(let a=0;a<200;a++){let a=1+(Math.random()*17|0),o=1+(Math.random()*17|0);if(t(a,o))continue;let s=r.filter(function(e){return t(a+e[0],o+e[1])});if(!s.length)continue;let c=Al(a,o),l=Math.hypot(c.x-e.x,c.z-e.z);if(l<n||l>i)continue;let u=s[Math.random()*s.length|0],d=Al(a+u[0],o+u[1]);return{x:c.x,z:c.z,tx:d.x,tz:d.z}}return null},stepToward:function(e,n){if(e[0]===n[0]&&e[1]===n[1])return null;let i=new Int8Array(361),a=new Int32Array(361).fill(-1),o=[e[0]*19+e[1]];i[o[0]]=1;let s=n[0]*19+n[1],c=!1;for(let e=0;e<o.length&&!c;e++){let n=o[e],l=n/19|0,u=n%19;for(let e=0;e<4;e++){let d=l+r[e][0],f=u+r[e][1];if(!t(d,f))continue;let p=d*19+f;if(!i[p]){if(i[p]=1,a[p]=n,p===s){c=!0;break}o.push(p)}}}if(!c)return null;let l=s;for(;a[l]!==e[0]*19+e[1];)if(l=a[l],l<0)return null;return[l/19|0,l%19]},awayFrom:function(e,n){let i=null,a=-1;for(let o=0;o<4;o++){let s=e[0]+r[o][0],c=e[1]+r[o][1];if(!t(s,c))continue;let l=Al(s,c),u=(l.x-n.x)*(l.x-n.x)+(l.z-n.z)*(l.z-n.z);u>a&&(a=u,i=[s,c])}return i},sees:function(e,r){let i=r.x-e.x,a=r.z-e.z,o=Math.ceil(Math.hypot(i,a)/.7);for(let r=1;r<o;r++){let s=n(e.x+i*r/o,e.z+a*r/o);if(!t(s[0],s[1]))return!1}return!0}}}function Wd(e,t,n){let r=new q(new Yi(t,n),new J({map:e,side:2,alphaTest:.5,roughness:.9,metalness:0}));return r.castShadow=!0,r}function Gd(e,t){e.rotation.y=Math.atan2(t.x-e.position.x,t.z-e.position.z)}function Kd(e){return e[0]+Math.random()*(e[1]-e[0])}function qd(e,t,n,r){let i=Wd(n,t.w,t.h);i.name=t.kind,i.visible=!1,e.add(i);let a=new U,o=new U,s=`away`,c=Kd([4,t.rest[1]]),l=null,u=0,d=0;function f(){s=`away`,i.visible=!1,c=Kd(t.rest)}function p(e){if(t.path){let n=r.randomOpen(e,13,21);if(!n||r.sees(n,e))return!1;a.set(n.x,t.h/2,n.z),l=[n.fx,n.fy],o.copy(e)}else{let n=r.randomEdge(e,4.5,t.notice*.8);if(!n)return!1;a.set(n.x,t.h/2,n.z),o.set(n.tx,t.h/2,n.tz)}return i.position.copy(a),i.visible=!0,s=`coming`,c=9,u=0,!0}function m(e,t,n,r){let i=t-a.x,o=n-a.z,s=Math.hypot(i,o);if(s<.02)return 0;let c=Math.min(s,r*e);return a.x+=i/s*c,a.z+=o/s*c,d+=c,s-c}return{update:function(e,n,h,g,_){let v=h.x-a.x,y=h.z-a.z,b=Math.hypot(v,y);if(c-=e,s===`away`){let e=t.path?1-.45*g:.55+.45*g;c<=0&&(c=6,Math.random()<e&&p(h));return}if(s===`coming`){if(t.path){if(u-=e,u<=0){u=1.1;let e=r.cellOf(h.x,h.z),t=r.stepToward(l,e);if(t){l=t;let e=Al(t[0],t[1]);o.set(e.x,a.y,e.z)}}m(e,o.x,o.z,t.speed*.62);let n=r.cellOf(a.x,a.z);n[0]===l[0]&&n[1]===l[1]&&(u=Math.min(u,.2))}else m(e,o.x,o.z,t.speed*.55);(b<t.spook+2.2||c<=0||!t.path&&Math.hypot(o.x-a.x,o.z-a.z)<.15)&&(s=`watching`,c=Kd(t.watch),t.voice&&Math.random()<.45&&_(t.voice,b))}else if(s===`watching`)(c<=0||b<t.spook)&&(s=`going`,c=6,t.voice&&b<t.spook&&Math.random()<.5&&_(t.voice,b),_(`bolt`,b),t.path&&(l=r.cellOf(a.x,a.z)));else if(s===`going`){if(t.path){if(Math.hypot(o.x-a.x,o.z-a.z)<.4||u<=0){let e=r.awayFrom(l,h);if(e){l=e;let t=Al(e[0],e[1]);o.set(t.x,a.y,t.z)}u=2.5}u-=e,m(e,o.x,o.z,t.speed*1.5)}else{let n=Math.atan2(-v,-y);m(e,a.x+Math.sin(n)*4,a.z+Math.cos(n)*4,t.speed*1.6)}(c<=0||b>Vd||b>6&&!r.sees(a,h))&&f()}let x=s===`watching`?Math.sin(n*1.7)*t.h*.012:Math.sin(d*4.5)*t.h*.028;i.position.set(a.x,t.h/2+x,a.z),Gd(i,h)}}}function Jd(e,t,n){let r=Wd(t.snake,1.05,.34);r.castShadow=!1,e.add(r);let i=new U,a=`lying`,o=0,s=Math.random()*6.28;function c(e){let t=n.randomOpen(e,14,30)||n.randomOpen(e,0,40);t&&i.set(t.x,.13,t.z),a=`lying`,r.visible=!0}return c(new U(0,0,0)),{update:function(e,t,l,u,d,f){let p=l.x-i.x,m=l.z-i.z,h=Math.hypot(p,m)||1e-4,g=d>.4?(u.x*p+u.z*m)/(d*h):0;if(o-=e,a===`lying`)h<5.5&&(a=`roused`,o=1.4,f(`rattle`,h));else if(a===`roused`)o<=0&&(g<-.55?(a=`chasing`,o=1.6+Math.random()*1.6,f(`rattle`,h)):(a=`leaving`,o=4,s=Math.atan2(-p,-m)+(Math.random()-.5)));else if(a===`chasing`){if(h>1.4){let t=1.55*e/h;i.x+=p*t,i.z+=m*t}(o<=0||h>9||g>-.2)&&(a=`leaving`,o=4,s=Math.atan2(-p,-m))}else a===`leaving`&&(i.x+=Math.sin(s)*1.25*e,i.z+=Math.cos(s)*1.25*e,o<=0&&(h>12||!n.sees(i,l)?c(l):(a=`lying`,o=6)));let _=+(a===`roused`||a===`chasing`);return r.scale.set(1,1+_*.45,1),r.position.set(i.x,.13+_*.1+Math.sin(t*3+i.x)*.01,i.z),Gd(r,l),a===`lying`?0:Math.max(0,1-h/7)*(a===`chasing`?1:.7)}}}function Yd(e,t,n){let r=new sn,i=[];for(let e=0;e<3;e++){let e=Wd(t.bee,.24,.18);e.castShadow=!1,r.add(e),i.push({mesh:e,phase:Math.random()*6.28,r:.25+Math.random()*.35,rate:1.6+Math.random()*1.4})}e.add(r);let a=new U,o=`hovering`,s=0;function c(e){let t=n.randomOpen(e,12,30)||n.randomOpen(e,0,40);t&&a.set(t.x,1.15,t.z),o=`hovering`}c(new U(0,0,0));let l={buzz:0,update:function(e,t,r,u,d,f){let p=r.x-a.x,m=r.z-a.z,h=Math.hypot(p,m)||1e-4,g=d>.4?(u.x*p+u.z*m)/(d*h):0;if(s-=e,o===`hovering`){if(h<4.5)o=`roused`,s=1;else if(s<=0){s=6+Math.random()*8;let e=n.randomOpen(a,1,6);e&&(a.x+=(e.x-a.x)*.35,a.z+=(e.z-a.z)*.35)}}else if(o===`roused`)s<=0&&(o=g<-.5?`following`:`settling`,s=o===`following`?2+Math.random()*2:5,o===`following`&&f(`buzzUp`,h));else if(o===`following`){if(h>1.6){let t=1.75*e/h;a.x+=p*t,a.z+=m*t}(s<=0||h>10||g>-.15)&&(o=`settling`,s=5)}else o===`settling`&&s<=0&&(h>11||!n.sees(a,r)?c(r):(o=`hovering`,s=6));for(let e=0;e<i.length;e++){let n=i[e],o=t*n.rate+n.phase;n.mesh.position.set(a.x+Math.sin(o)*n.r,a.y+Math.sin(o*2.3+n.phase)*.14,a.z+Math.cos(o*1.3)*n.r),Gd(n.mesh,r)}let _=Math.max(0,1-h/6);return l.buzz=_*(o===`following`?1:.8),o===`hovering`?_*.35:_}};return l}function Xd(e,t,n){let r=Wd(t.web,1.5,1.5);r.castShadow=!1;let i=Wd(t.spider,.3,.26);i.castShadow=!1,e.add(r),e.add(i);let a=n.randomOpen({x:0,z:0},8,26)||{x:6,z:6},o=new U(a.x,1.55,a.z);r.position.copy(o);let s=0;return{update:function(e,t,n){let a=Math.hypot(n.x-o.x,n.z-o.z);return s+=(+(a<3)-s)*Math.min(1,e*2.2),r.position.y=o.y,Gd(r,n),i.position.set(o.x,o.y+s*.62+Math.sin(t*.9)*.02*(1-s),o.z),Gd(i,n),Math.max(0,1-a/5)*.55}}}function Zd(e,t){let n=Wd(t.crow,1,.62);n.castShadow=!1,n.visible=!1,e.add(n);let r=new U,i=new U,a=new U,o=`gone`,s=20+Math.random()*70,c=0,l=!1;function u(e){let t=Math.random()*Math.PI*2,n=t+Math.PI*(.55+Math.random()*.9);r.set(e.x+Math.cos(t)*70,16+Math.random()*10,e.z+Math.sin(t)*70),i.set(e.x+Math.cos(n)*70,14+Math.random()*12,e.z+Math.sin(n)*70),l=Math.random()<.45;let s=Math.random()*Math.PI*2;a.set(e.x+Math.cos(s)*7,3.15,e.z+Math.sin(s)*7),o=`crossing`,c=0}return{update:function(e,t,d,f,p){if(s-=e,o===`gone`){s<=0&&(s=25+Math.random()*80,f<.5&&u(d));return}if(n.visible=!0,o===`crossing`||o===`leaving`){let u=o===`crossing`?r:a,d=o===`crossing`&&l?a:i;c+=e*(o===`crossing`&&l?.14:.055);let f=Math.min(1,c);n.position.set(u.x+(d.x-u.x)*f,u.y+(d.y-u.y)*f-Math.sin(f*Math.PI)*2.5,u.z+(d.z-u.z)*f),n.scale.set(1,.72+.34*Math.abs(Math.sin(t*7.5)),1),f>=1&&(o===`crossing`&&l?(o=`perched`,s=4+Math.random()*7,p(`crow`,6)):(o=`gone`,n.visible=!1,s=30+Math.random()*90))}else if(o===`perched`){n.position.copy(a),n.position.y=a.y+Math.sin(t*1.3)*.04,n.scale.set(1,1,1);let r=Math.hypot(d.x-a.x,d.z-a.z);s<=0||r<3.5?(o=`leaving`,c=0,p(`crow`,r)):Math.random()<e*.35&&p(`crow`,r)}Gd(n,d)}}}function Qd(e){return{deer:$d(256,224,nf,e),turkey:$d(200,200,rf,e),raccoon:$d(224,160,af,e),rabbit:$d(160,160,of,e),mouse:$d(160,112,sf,e),crow:$d(224,144,cf,e),snake:$d(256,96,lf,e),bee:$d(64,48,uf,e),spider:$d(96,84,df,e),web:$d(192,192,ff,e)}}function $d(e,t,n,r){let i=document.createElement(`canvas`);i.width=e,i.height=t;let a=i.getContext(`2d`);a.lineJoin=`round`,a.lineCap=`round`,n(a,e,t);let o=new zi(i);return o.anisotropy=r,o}function Q(e,t,n){e.fillStyle=n,e.beginPath(),e.moveTo(t[0][0],t[0][1]);for(let n=1;n<t.length;n++){let r=t[n];r.length===4?e.quadraticCurveTo(r[0],r[1],r[2],r[3]):e.lineTo(r[0],r[1])}e.closePath(),e.fill()}function ef(e,t,n,r,i,a,o,s,c){e.strokeStyle=c,e.lineWidth=s,e.beginPath(),e.moveTo(t,n),e.quadraticCurveTo(r,i,a,o),e.stroke()}function tf(e,t,n,r){e.fillStyle=`#120d08`,e.beginPath(),e.arc(t,n,r,0,Math.PI*2),e.fill(),e.fillStyle=`rgba(255,255,255,0.85)`,e.beginPath(),e.arc(t-r*.3,n-r*.35,r*.34,0,Math.PI*2),e.fill()}function nf(e){let t=`#a97443`;ef(e,84,132,78,168,82,208,9,`#8a5c33`),ef(e,168,130,176,168,170,208,9,`#8a5c33`),ef(e,100,134,96,170,100,208,10,t),ef(e,156,132,164,170,158,208,10,t),Q(e,[[70,118],[70,78,118,74],[168,70,182,104],[188,136,150,146],[104,154,70,118]],t),Q(e,[[88,140],[120,152,168,140],[150,150,88,140]],`#c9a271`),Q(e,[[74,96],[58,78,62,104],[72,118,74,96]],`#efe4d2`),Q(e,[[160,96],[176,62,192,44],[206,34,200,62],[190,96,160,96]],t),Q(e,[[186,52],[214,30,232,44],[238,56,214,66],[192,70,186,52]],t),Q(e,[[224,46],[238,42,244,54],[246,62,230,62],[222,58,224,46]],`#6d452a`),Q(e,[[188,40],[176,20,194,26],[206,32,188,40]],t),Q(e,[[204,34],[212,12,220,30],[224,40,204,34]],t),e.strokeStyle=`#8d7a58`,e.lineWidth=4,e.beginPath(),e.moveTo(198,30),e.quadraticCurveTo(196,8,208,2),e.moveTo(200,18),e.lineTo(186,8),e.moveTo(212,34),e.quadraticCurveTo(218,12,232,8),e.stroke(),tf(e,216,50,4.2),e.fillStyle=`#2a1c12`,e.beginPath(),e.ellipse(240,56,3.4,2.4,0,0,Math.PI*2),e.fill(),e.fillStyle=`rgba(255,244,220,0.5)`;for(let t=0;t<12;t++)e.beginPath(),e.arc(96+Math.random()*76,88+Math.random()*34,2.4,0,Math.PI*2),e.fill()}function rf(e){for(let t=0;t<11;t++){let n=-2.55+t*.135;e.strokeStyle=t%2?`#4a3a24`:`#6b573a`,e.lineWidth=13,e.beginPath(),e.moveTo(74,128),e.lineTo(74+Math.cos(n)*74,128+Math.sin(n)*74),e.stroke()}e.strokeStyle=`#c9b489`,e.lineWidth=5,e.beginPath(),e.arc(74,128,70,-2.6,-.15),e.stroke(),ef(e,108,158,106,176,100,192,5,`#b08040`),ef(e,126,158,130,176,136,192,5,`#b08040`),e.strokeStyle=`#b08040`,e.lineWidth=4,e.beginPath(),e.moveTo(100,192),e.lineTo(88,196),e.moveTo(100,192),e.lineTo(96,200),e.moveTo(136,192),e.lineTo(148,196),e.moveTo(136,192),e.lineTo(140,200),e.stroke(),Q(e,[[88,120],[96,82,132,88],[166,96,158,134],[150,168,108,162],[80,152,88,120]],`#3d3122`),Q(e,[[104,132],[126,118,150,132],[156,152,104,132]],`#5b4a30`),e.fillStyle=`rgba(70,110,86,0.42)`,e.beginPath(),e.ellipse(128,126,26,16,-.3,0,Math.PI*2),e.fill(),Q(e,[[140,100],[148,66,158,46],[170,30,176,52],[166,86,140,100]],`#6a5a45`),Q(e,[[160,44],[172,24,186,36],[196,46,178,56],[162,58,160,44]],`#b8bcc4`),e.fillStyle=`#c0392b`,e.beginPath(),e.ellipse(170,58,7,12,.2,0,Math.PI*2),e.fill(),e.beginPath(),e.ellipse(186,38,4,9,.5,0,Math.PI*2),e.fill(),e.fillStyle=`#e8c07a`,e.beginPath(),e.moveTo(192,44),e.lineTo(200,48),e.lineTo(190,51),e.closePath(),e.fill(),tf(e,180,41,3)}function af(e){let t=`#7f7c73`,n=`#33322f`,r=`#c9c5b8`;for(let r=10;r>=0;r--){let i=r/10,a=76-i*62,o=104-i*44+Math.sin(i*2.2)*6;e.fillStyle=r%3==0?n:r%3==1?`#8f8b80`:t,e.beginPath(),e.arc(a,o,17-i*6,0,Math.PI*2),e.fill()}ef(e,96,122,92,138,96,150,13,n),ef(e,152,120,158,138,154,150,13,n),Q(e,[[66,112],[74,70,122,68],[166,66,174,104],[180,138,118,142],[62,140,66,112]],t),Q(e,[[76,124],[116,140,170,122],[156,142,76,124]],`#605d56`),Q(e,[[150,92],[154,56,186,56],[220,56,218,92],[216,126,180,124],[146,118,150,92]],t),e.fillStyle=t,e.beginPath(),e.arc(160,60,13,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(210,60,13,0,Math.PI*2),e.fill(),e.fillStyle=`#5d5a53`,e.beginPath(),e.arc(160,62,7,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(210,62,7,0,Math.PI*2),e.fill(),Q(e,[[152,92],[156,70,184,70],[214,70,216,94],[218,122,184,124],[150,116,152,92]],r),e.fillStyle=n,e.beginPath(),e.moveTo(150,84),e.quadraticCurveTo(184,76,218,84),e.quadraticCurveTo(220,104,214,104),e.quadraticCurveTo(184,96,154,104),e.quadraticCurveTo(148,102,150,84),e.fill(),e.fillStyle=r,e.beginPath(),e.ellipse(184,74,22,5,0,0,Math.PI*2),e.fill(),e.fillStyle=`#efece2`,e.beginPath(),e.arc(167,91,5.4,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(201,91,5.4,0,Math.PI*2),e.fill(),e.fillStyle=`#111`,e.beginPath(),e.arc(168,91,3.2,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(202,91,3.2,0,Math.PI*2),e.fill(),Q(e,[[172,108],[184,104,196,108],[198,122,184,126],[170,122,172,108]],r),e.fillStyle=`#1b1a18`,e.beginPath(),e.ellipse(184,112,6.5,5,0,0,Math.PI*2),e.fill(),e.strokeStyle=`#1b1a18`,e.lineWidth=1.6,e.beginPath(),e.moveTo(184,116),e.lineTo(184,122),e.stroke()}function of(e){let t=`#9c8265`;ef(e,66,108,60,124,70,132,12,`#8a7156`),Q(e,[[48,100],[52,66,88,62],[126,58,128,96],[130,130,82,132],[44,130,48,100]],t),Q(e,[[56,116],[88,132,124,118],[110,134,56,116]],`#c6b295`),e.fillStyle=`#efe8dc`,e.beginPath(),e.arc(44,104,13,0,Math.PI*2),e.fill(),Q(e,[[112,82],[116,54,140,54],[164,54,162,84],[160,110,130,108],[108,104,112,82]],t),Q(e,[[122,62],[110,14,128,12],[142,12,134,62]],t),Q(e,[[126,30],[122,22,130,20],[136,20,132,34]],`#d9a8a8`),Q(e,[[144,60],[150,18,164,24],[176,30,154,66]],t),tf(e,148,76,5),e.fillStyle=`#3a2a22`,e.beginPath(),e.ellipse(163,90,4,3,0,0,Math.PI*2),e.fill(),e.strokeStyle=`rgba(240,230,215,0.6)`,e.lineWidth=1.4;for(let t=-2;t<=2;t++)e.beginPath(),e.moveTo(162,90),e.lineTo(196,84+t*7),e.stroke()}function sf(e){let t=`#8a8079`;e.strokeStyle=`#c2a7a0`,e.lineWidth=3,e.beginPath(),e.moveTo(38,74),e.quadraticCurveTo(10,62,16,40),e.stroke(),Q(e,[[34,72],[40,44,70,44],[104,44,108,70],[110,92,66,94],[30,92,34,72]],t),Q(e,[[100,62],[104,44,124,46],[146,50,142,72],[138,90,110,86],[96,80,100,62]],t),e.fillStyle=`#d6b6b0`,e.beginPath(),e.arc(104,46,17,0,Math.PI*2),e.fill(),e.fillStyle=t,e.beginPath(),e.arc(104,46,13,0,Math.PI*2),e.fill(),e.fillStyle=`#d6b6b0`,e.beginPath(),e.arc(130,44,12,0,Math.PI*2),e.fill(),tf(e,128,66,3.4),e.fillStyle=`#c98d8d`,e.beginPath(),e.arc(146,74,3,0,Math.PI*2),e.fill(),e.strokeStyle=`rgba(230,225,220,0.7)`,e.lineWidth=1;for(let t=-1;t<=1;t++)e.beginPath(),e.moveTo(144,74),e.lineTo(160,68+t*8),e.stroke()}function cf(e){let t=`#171a1f`;Q(e,[[104,68],[70,30,22,30],[58,52,100,74]],t),Q(e,[[118,68],[156,34,204,40],[166,58,122,76]],`#1f2329`),Q(e,[[82,74],[92,52,120,54],[154,56,152,78],[150,98,110,98],[78,94,82,74]],t),Q(e,[[86,84],[56,96,34,110],[64,98,88,92]],t),Q(e,[[146,62],[152,44,168,46],[186,48,180,66],[174,82,150,78]],t),e.fillStyle=`#3a3a33`,e.beginPath(),e.moveTo(180,56),e.lineTo(206,62),e.lineTo(180,68),e.closePath(),e.fill(),e.fillStyle=`#c9c2ae`,e.beginPath(),e.arc(169,58,3.6,0,Math.PI*2),e.fill(),e.fillStyle=`#0a0a0c`,e.beginPath(),e.arc(169,58,2,0,Math.PI*2),e.fill()}function lf(e,t,n){let r=[];for(let e=0;e<=40;e++){let i=e/40;r.push([14+i*(t-40),n*.66+Math.sin(i*7.2)*n*.2*(1-i*.55)])}for(let t=0;t<r.length-1;t++){let n=t/(r.length-1);e.strokeStyle=`#5d6b3a`,e.lineWidth=16*(.35+.65*Math.sin(Math.PI*Math.min(1,n*1.15))),e.beginPath(),e.moveTo(r[t][0],r[t][1]),e.lineTo(r[t+1][0],r[t+1][1]),e.stroke(),t%4==0&&(e.strokeStyle=`rgba(40,44,24,0.75)`,e.lineWidth*=.9,e.beginPath(),e.moveTo(r[t][0],r[t][1]),e.lineTo(r[t+1][0],r[t+1][1]),e.stroke())}let i=r[r.length-1][0],a=r[r.length-1][1];Q(e,[[i-12,a],[i-4,a-26,i+14,a-24],[i+34,a-22,i+30,a-6],[i+26,a+8,i-12,a]],`#67763f`),e.fillStyle=`#e8d24a`,e.beginPath(),e.arc(i+16,a-15,4.2,0,Math.PI*2),e.fill(),e.fillStyle=`#101008`,e.beginPath(),e.ellipse(i+16,a-15,1.3,4,0,0,Math.PI*2),e.fill(),e.strokeStyle=`#b03a3a`,e.lineWidth=2,e.beginPath(),e.moveTo(i+30,a-6),e.lineTo(i+46,a-2),e.moveTo(i+46,a-2),e.lineTo(i+54,a-8),e.moveTo(i+46,a-2),e.lineTo(i+54,a+3),e.stroke()}function uf(e,t,n){e.fillStyle=`rgba(226,236,244,0.55)`,e.beginPath(),e.ellipse(t*.42,n*.3,13,7,-.5,0,Math.PI*2),e.fill(),e.beginPath(),e.ellipse(t*.58,n*.3,13,7,.5,0,Math.PI*2),e.fill(),e.fillStyle=`#d8a72a`,e.beginPath(),e.ellipse(t*.5,n*.58,15,9,0,0,Math.PI*2),e.fill(),e.fillStyle=`#221c10`;for(let r=-1;r<=1;r++)e.beginPath(),e.ellipse(t*.5+r*7,n*.58,2.6,8.6,0,0,Math.PI*2),e.fill();e.beginPath(),e.arc(t*.5-15,n*.56,5,0,Math.PI*2),e.fill()}function df(e,t,n){let r=`#1c1a1e`;e.strokeStyle=r;for(let n=0;n<4;n++){let r=30+n*8;e.lineWidth=3-n*.3,e.beginPath(),e.moveTo(t*.5,r),e.quadraticCurveTo(t*.5-22-n*6,r-14+n*9,t*.5-36-n*5,r+18+n*6),e.stroke(),e.beginPath(),e.moveTo(t*.5,r),e.quadraticCurveTo(t*.5+22+n*6,r-14+n*9,t*.5+36+n*5,r+18+n*6),e.stroke()}e.fillStyle=r,e.beginPath(),e.ellipse(t*.5,n*.58,15,19,0,0,Math.PI*2),e.fill(),e.beginPath(),e.ellipse(t*.5,n*.33,9,8,0,0,Math.PI*2),e.fill(),e.fillStyle=`#c8b23c`,e.beginPath(),e.ellipse(t*.5,n*.58,6,11,0,0,Math.PI*2),e.fill(),e.fillStyle=`#e6e2d6`,e.beginPath(),e.arc(t*.5-3.5,n*.3,1.7,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(t*.5+3.5,n*.3,1.7,0,Math.PI*2),e.fill()}function ff(e,t,n){let r=t/2,i=n/2,a=t*.47;e.strokeStyle=`rgba(232,238,240,0.55)`,e.lineWidth=1.1;for(let t=0;t<12;t++){let n=t/12*Math.PI*2;e.beginPath(),e.moveTo(r,i),e.lineTo(r+Math.cos(n)*a,i+Math.sin(n)*a),e.stroke()}for(let t=1;t<=7;t++){let n=t/7*a*(.35+.65*t/7);e.beginPath();for(let t=0;t<=12;t++){let a=t/12*Math.PI*2,o=n*(t%2?.97:1),s=r+Math.cos(a)*o,c=i+Math.sin(a)*o;t===0?e.moveTo(s,c):e.lineTo(s,c)}e.stroke()}}var pf=190,mf=150,hf=3.4,gf=.36,_f=[240,420],vf=[260,540],yf=[90,220],bf=1600,xf=22,Sf=13,Cf=11.5;function wf(e){let t={value:Ef()},n={value:new H(0,0)},r={value:1/pf},i={value:.55},a={value:0},o=Df(t,n,r,i);e.add(o);let s=kf();e.add(s.mesh);let c=.16+Math.random()*.14,l=c,u=0,d=0,f=_f[0]+Math.random()*(_f[1]-_f[0]),p=!1,m=new H(.78,.62).normalize();function h(){p=!0,d=.55+Math.random()*.45,l=.82+Math.random()*.14,f=yf[0]+Math.random()*(yf[1]-yf[0])}function g(){p=!1,d=0,l=.12+Math.random()*.3,f=vf[0]+Math.random()*(vf[1]-vf[0])}let _={rain:0,cover:c};return{state:_,patch:function(e){Of(e,t,n,r,i,a)},shower:h,update:function(e,t,r,v,y){f-=e,f<=0&&(p?g():h()),c+=(l-c)*Math.min(1,e/55),u+=(d-u)*Math.min(1,e/14),_.rain=u,_.cover=c,n.value.x-=m.x*hf*e/pf,n.value.y-=m.y*hf*e/pf,i.value=.74-.46*c,a.value=gf*Tf(-.02,.16,r);let b=.55+.45*Tf(-.1,.25,r);o.material.uniforms.uTint.value.copy(y).multiplyScalar(b*(1-.55*v)),o.material.uniforms.uOpacity.value=.82,o.position.set(t.x,mf,t.z),s.update(e,t,u,v)},get fogBoost(){return u*.02},get lightDamp(){return Math.min(.6,Math.max(0,c-.45)*.8+u*.34)}}}function Tf(e,t,n){let r=Math.max(0,Math.min(1,(n-e)/(t-e)));return r*r*(3-2*r)}function Ef(){let t=document.createElement(`canvas`);t.width=t.height=512;let n=t.getContext(`2d`);n.fillStyle=`#000`,n.fillRect(0,0,512,512),n.globalCompositeOperation=`lighter`;let r=[[5,170,.42],[12,104,.34],[34,58,.26],[90,26,.18]];for(let e=0;e<r.length;e++){let t=r[e][0],i=r[e][1],a=r[e][2];for(let e=0;e<t;e++){let e=Math.random()*512,t=Math.random()*512,r=i*(.6+Math.random()*.8);for(let i=-1;i<=1;i++)for(let o=-1;o<=1;o++){let s=e+i*512,c=t+o*512;if(s<-r||s>512+r||c<-r||c>512+r)continue;let l=n.createRadialGradient(s,c,0,s,c,r);l.addColorStop(0,`rgba(255,255,255,`+a+`)`),l.addColorStop(1,`rgba(255,255,255,0)`),n.fillStyle=l,n.beginPath(),n.arc(s,c,r,0,Math.PI*2),n.fill()}}}let i=new zi(t);return i.wrapS=i.wrapT=e,i}function Df(e,t,n,r){let i=new q(new Yi(1600,1600,1,1),new oa({transparent:!0,depthWrite:!1,depthTest:!0,fog:!1,side:2,uniforms:{uCloudMap:e,uCloudScroll:t,uCloudScale:n,uCloudCut:r,uTint:{value:new K(16777215)},uOpacity:{value:.85}},vertexShader:`
        varying vec2 vWorld;
        void main() {
...
`))},e.needsUpdate=!0}function kf(){let e=new Float32Array(bf*6),t=new Float32Array(bf*4);for(let e=0;e<bf;e++)t[e*4]=(Math.random()-.5)*xf,t[e*4+1]=Math.random()*Sf,t[e*4+2]=(Math.random()-.5)*xf,t[e*4+3]=.82+Math.random()*.36;let n=new ur;n.setAttribute(`position`,new Yn(e,3));let r=new Ai(n,new vi({color:13162208,transparent:!0,opacity:0,depthWrite:!1,fog:!0}));r.frustumCulled=!1,r.visible=!1;let i=.16,a=.13;return{mesh:r,update:function(o,s,c,l){if(r.visible=c>.01,!r.visible)return;r.material.opacity=(.3+.16*l)*Math.min(1,c*1.3);let u=.55+.5*c;for(let n=0;n<bf;n++){let r=n*4;t[r+1]-=Cf*t[r+3]*o,t[r]+=i*Cf*t[r+3]*o,t[r+2]+=a*Cf*t[r+3]*o,t[r+1]<-3&&(t[r]=(Math.random()-.5)*xf,t[r+1]=Sf,t[r+2]=(Math.random()-.5)*xf);let c=s.x+t[r],l=s.y+t[r+1]-1.4,d=s.z+t[r+2],f=n*6;e[f]=c,e[f+1]=l,e[f+2]=d,e[f+3]=c-i*u,e[f+4]=l+u,e[f+5]=d-a*u}n.attributes.position.needsUpdate=!0}}}var Af=[{url:`https://wave-racer.vercel.app/`,name:`Wave Racer`,line:`salt water, at speed`,art:`wave`,a:858716,b:4869078,c:14214911},{url:`https://apex-formula-2026.vercel.app/`,name:`Apex Formula 2026`,line:`the racing line`,art:`race`,a:3999539,b:12593806,c:16767218},{url:`https://genex.games/world/skate`,name:`Skate`,line:`concrete and gravity`,art:`skate`,a:2755410,b:10173400,c:15782143},{url:`https://play.mint.gg/complete-shelf`,name:`Complete Shelf`,line:`put it all in order`,art:`shelf`,a:1970752,b:6970072,c:14472959},{url:`https://starknightt.github.io/operation-ironhold/`,name:`Operation Ironhold`,line:`hold the line`,art:`ironhold`,a:2820654,b:8073136,c:15124735},{url:`https://nuketown.luckeysystems.com/`,name:`Nuketown`,line:`a town, briefly`,art:`nuketown`,a:3804474,b:10957760,c:16766710},{url:`https://mrdoob.github.io/toys/`,a:2297674,b:9387984,c:15916287},{url:`https://maize.live`,a:3018318,b:9057480,c:16178376}],jf=1.5,Mf=2.55,Nf=.26,Pf=.2,Ff=.42,If=1.7,Lf=34;function Rf(e,t,n,r,i,a){let o=new sn,s=[],c=[],l=Yf(e,t,n,r,i||[],Af.length),u=new J({color:2366e3,roughness:.52,metalness:.3,flatShading:!0}),d=Zf(),f=Qf(),p=$f();for(let e=0;e<l.length;e++){let t=l[e],n=Af[e],r=new sn;r.position.set(t.x,0,t.z),r.rotation.y=Math.atan2(t.outX,t.outZ),o.add(r),Bf(r,u);let i=new q(new Yi(1.54,2.59),new Br({color:new K(n.a).multiplyScalar(.3),fog:!1}));i.position.set(0,Mf/2,-.04),r.add(i);let a=zf(n),m=new q(new Yi(jf,Mf),a);m.position.set(0,Mf/2,0),r.add(m);let h=new Ar(new gr({map:d,color:n.b,transparent:!0,opacity:.4,depthWrite:!1,blending:2}));h.scale.set(4.4,4.4,1),h.position.set(0,Mf*.52,.05),r.add(h);let g=new q(new Yi(3.4,3.4),new Br({map:f,color:n.b,transparent:!0,opacity:0,depthWrite:!1,blending:2,fog:!1}));g.rotation.x=-Math.PI/2,g.position.set(0,.025,1.25),r.add(g);let _=Hf(r,n,p);if(n.name){let e=t.signSide,i=Gf(n);i.position.set(e*1.15,0,.85),i.rotation.y=-e*.45,r.add(i),s.push({x:t.x+t.rightX*e*1.15+t.outX*.85,z:t.z+t.rightZ*e*1.15+t.outZ*.85,r:.34})}c.push({dest:n,x:t.x,z:t.z,nx:t.outX,nz:t.outZ,rx:t.rightX,rz:t.rightZ,mat:a,halo:h,pool:g,motes:_,charge:0,near:0})}let m=null;return{group:o,obstacles:s,level:0,update:function(e,t,n,r){let i=0;for(let o=0;o<c.length;o++){let s=c[o],l=n.x-s.x,u=n.z-s.z,d=l*s.nx+u*s.nz,f=l*s.rx+u*s.rz,p=Math.sqrt(l*l+u*u),h=d>-.2&&d<Ff&&Math.abs(f)<jf*.5;m||(s.charge=Math.max(0,Math.min(1,s.charge+(h?If:-2.6)*e)),s.charge>=1&&(m=s.dest,a&&a(s.dest))),s.near=Math.max(0,1-p/7),i=Math.max(i,Math.max(s.near,s.charge)),s.mat.uniforms.uTime.value=t,s.mat.uniforms.uCharge.value=s.charge,s.mat.uniforms.uNear.value=s.near;let g=.5+s.near*.35+s.charge*1.6;s.halo.material.opacity=.3*g,s.halo.scale.setScalar(4.4+s.charge*1.6),s.pool.material.opacity=(.16+.3*r)*g,Wf(s.motes,e,1+s.charge*2.2)}this.level=i}}}function zf(e){return new oa({transparent:!0,depthWrite:!1,side:2,blending:2,uniforms:{uTime:{value:0},uCharge:{value:0},uNear:{value:0},uA:{value:new K(e.a)},uB:{value:new K(e.b)},uC:{value:new K(e.c)}},vertexShader:[`varying vec2 vUv;`,`void main() {`,`  vUv = uv;`,`  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);`,`}`].join(`
...
`)})}function Bf(e,t){let n=2.02,r=[[.88,1.4049999999999998,Nf,2.8099999999999996,Pf],[-.88,1.4049999999999998,Nf,2.8099999999999996,Pf],[0,2.6799999999999997,n,Nf,Pf],[0,Nf*.28,n,Nf*.56,Pf*1.5]];for(let n=0;n<r.length;n++){let i=r[n],a=new q(Vf(new Ui(i[2],i[3],i[4],2,3,1),.022),t);a.position.set(i[0],i[1],-.2*.4),a.castShadow=!0,a.receiveShadow=!0,e.add(a)}for(let n=0;n<4;n++){let r=new q(Vf(new Ui(Nf*1.15,Nf*1.15,Pf*1.15),.03),t);r.position.set((n%2?1:-1)*.88,n<2?2.6799999999999997:Nf*.3,-.2*.4),r.rotation.z=(Math.random()-.5)*.16,r.castShadow=!0,e.add(r)}}function Vf(e,t){let n=e.attributes.position;for(let e=0;e<n.count;e++)n.setXYZ(e,n.getX(e)+(Math.random()-.5)*t,n.getY(e)+(Math.random()-.5)*t,n.getZ(e)+(Math.random()-.5)*t);return e.computeVertexNormals(),e}function Hf(e,t,n){let r=new ur,i=new Float32Array(102),a=new Float32Array(102),o=new Float32Array(Lf);for(let e=0;e<Lf;e++)Uf(i,a,o,e),o[e]=Math.random();r.setAttribute(`position`,new Yn(i,3));let s=new Ii(r,new ji({size:.065,map:n,color:t.c,transparent:!0,opacity:.6,depthWrite:!1,blending:2}));return e.add(s),{geo:r,pos:i,vel:a,life:o}}function Uf(e,t,n,r){e[r*3]=(Math.random()-.5)*jf*.85,e[r*3+1]=Math.random()*Mf,e[r*3+2]=.02,t[r*3]=(Math.random()-.5)*.16,t[r*3+1]=.12+Math.random()*.3,t[r*3+2]=.1+Math.random()*.34,n[r]=0}function Wf(e,t,n){let r=e.pos,i=e.vel,a=e.life;for(let e=0;e<Lf;e++){if(a[e]+=t*.34*n,a[e]>=1){Uf(r,i,a,e);continue}r[e*3]+=i[e*3]*t*n,r[e*3+1]+=i[e*3+1]*t*n,r[e*3+2]+=i[e*3+2]*t*n}e.geo.attributes.position.needsUpdate=!0}function Gf(e){let t=new sn,n=new J({color:5916201,roughness:.95}),r=new Gi(.038,.046,1.02,6);for(let e=0;e<2;e++){let i=new q(r,n);i.position.set((e?1:-1)*.33,.51,0),i.rotation.z=(Math.random()-.5)*.04,i.castShadow=!0,t.add(i)}let i=new J({map:Kf(e),roughness:.88}),a=new q(new Ui(.96,.72,.045),[n,n,n,n,i,n]);return a.position.set(0,1.36,.01),a.castShadow=!0,a.receiveShadow=!0,t.add(a),t}function Kf(e){let t=document.createElement(`canvas`);t.width=512,t.height=384;let n=t.getContext(`2d`);n.fillStyle=`#6d5735`,n.fillRect(0,0,512,384);for(let e=0;e<220;e++){let e=Math.random()*384;n.strokeStyle=`rgba(`+(60+Math.random()*50|0)+`,`+(44+Math.random()*40|0)+`,22,`+(.05+Math.random()*.18)+`)`,n.lineWidth=.6+Math.random()*2.4,n.beginPath(),n.moveTo(0,e),n.bezierCurveTo(170,e+(Math.random()-.5)*9,340,e+(Math.random()-.5)*9,512,e),n.stroke()}let r={x:26,y:24,w:460,h:208};n.save(),n.beginPath(),n.rect(r.x,r.y,r.w,r.h),n.clip(),Jf(n,e.art,r),n.restore(),n.strokeStyle=`rgba(240,226,192,0.62)`,n.lineWidth=3,n.strokeRect(r.x,r.y,r.w,r.h),n.lineWidth=2.5,n.strokeStyle=`rgba(240,226,192,0.34)`,n.strokeRect(10,10,492,364),n.textAlign=`center`,n.shadowColor=`rgba(28,18,4,0.75)`,n.shadowBlur=6,n.fillStyle=`#f6e8c6`,qf(n,e.name,448,38),n.fillText(e.name,256,292),n.font=`italic 22px Georgia, serif`,n.fillStyle=`rgba(232,210,166,0.82)`,n.fillText(e.line,256,330);let i=new zi(t);return i.anisotropy=8,i}function qf(e,t,n,r){let i=r;for(e.font=i+`px Georgia, serif`;i>20&&e.measureText(t).width>n;)i-=2,e.font=i+`px Georgia, serif`}function Jf(e,t,n){let r=n.x,i=n.y,a=n.w,o=n.h;function s(t,n){let s=e.createLinearGradient(0,i,0,i+o);s.addColorStop(0,t),s.addColorStop(1,n),e.fillStyle=s,e.fillRect(r,i,a,o)}if(t===`wave`){s(`#123a63`,`#2b7f9e`),e.fillStyle=`#0d2c4d`,e.beginPath(),e.moveTo(r,i+o),e.bezierCurveTo(r+a*.2,i+o*.3,r+a*.52,i+o*.16,r+a*.72,i+o*.52),e.bezierCurveTo(r+a*.82,i+o*.72,r+a*.9,i+o*.62,r+a,i+o*.7),e.lineTo(r+a,i+o),e.closePath(),e.fill(),e.strokeStyle=`rgba(226,244,255,0.85)`,e.lineWidth=6,e.beginPath(),e.moveTo(r+a*.02,i+o*.92),e.bezierCurveTo(r+a*.22,i+o*.32,r+a*.52,i+o*.18,r+a*.73,i+o*.54),e.stroke();for(let t=0;t<60;t++)e.fillStyle=`rgba(238,250,255,`+(.2+Math.random()*.6)+`)`,e.beginPath(),e.arc(r+a*(.45+Math.random()*.34),i+o*(.14+Math.random()*.34),1+Math.random()*3,0,Math.PI*2),e.fill();e.fillStyle=`#f2c14a`,e.beginPath(),e.moveTo(r+a*.8,i+o*.6),e.lineTo(r+a*.92,i+o*.66),e.lineTo(r+a*.8,i+o*.7),e.closePath(),e.fill()}else if(t===`race`){s(`#1b1b22`,`#33323c`),e.fillStyle=`#26262c`,e.beginPath(),e.moveTo(r-20,i+o),e.lineTo(r+a*.4,i+o*.18),e.lineTo(r+a*.56,i+o*.18),e.lineTo(r+a+20,i+o),e.closePath(),e.fill();for(let t=0;t<9;t++){let n=t/9,s=(t+.5)/9;e.fillStyle=t%2?`#e8e4dc`:`#c8302f`,e.beginPath(),e.moveTo(r+a*(.4-.42*n)-14,i+o*(.18+.82*n)),e.lineTo(r+a*(.4-.42*s)-14,i+o*(.18+.82*s)),e.lineTo(r+a*(.4-.42*s)-34,i+o*(.18+.82*s)),e.lineTo(r+a*(.4-.42*n)-34,i+o*(.18+.82*n)),e.closePath(),e.fill()}e.strokeStyle=`rgba(240,238,230,0.8)`,e.lineWidth=4,e.setLineDash([16,22]),e.beginPath(),e.moveTo(r+a*.52,i+o*.2),e.lineTo(r+a*.6,i+o),e.stroke(),e.setLineDash([]),e.fillStyle=`#e0344f`,e.beginPath(),e.moveTo(r+a*.42,i+o*.92),e.lineTo(r+a*.66,i+o*.8),e.lineTo(r+a*.62,i+o*.62),e.lineTo(r+a*.44,i+o*.66),e.closePath(),e.fill(),e.fillStyle=`#1c1c22`,e.fillRect(r+a*.4,i+o*.86,a*.3,o*.06)}else if(t===`skate`)s(`#c9924a`,`#e8c98a`),e.fillStyle=`#8f8b84`,e.beginPath(),e.moveTo(r,i+o*.42),e.bezierCurveTo(r+a*.26,i+o*.98,r+a*.74,i+o*.98,r+a,i+o*.42),e.lineTo(r+a,i+o),e.lineTo(r,i+o),e.closePath(),e.fill(),e.strokeStyle=`rgba(60,56,50,0.4)`,e.lineWidth=3,e.beginPath(),e.moveTo(r,i+o*.52),e.bezierCurveTo(r+a*.26,i+o*1.04,r+a*.74,i+o*1.04,r+a,i+o*.52),e.stroke(),e.fillStyle=`#20201e`,e.beginPath(),e.arc(r+a*.68,i+o*.22,11,0,Math.PI*2),e.fill(),e.strokeStyle=`#20201e`,e.lineWidth=9,e.beginPath(),e.moveTo(r+a*.68,i+o*.3),e.lineTo(r+a*.72,i+o*.48),e.lineTo(r+a*.63,i+o*.6),e.stroke(),e.beginPath(),e.moveTo(r+a*.69,i+o*.36),e.lineTo(r+a*.58,i+o*.44),e.stroke(),e.save(),e.translate(r+a*.63,i+o*.63),e.rotate(-.5),e.fillStyle=`#d9483e`,e.fillRect(-34,-5,68,10),e.restore();else if(t===`shelf`){s(`#3a2e46`,`#54415c`);let t=[`#d8a45a`,`#7fb0c4`,`#c96f6a`,`#8fae72`,`#e0cf9a`,`#9a7fc4`];for(let n=0;n<3;n++){let s=i+o*(.26+n*.25);e.fillStyle=`#8a6a3e`,e.fillRect(r+a*.1,s,a*.8,9);let c=r+a*.12;for(;c<r+a*.86;){let i=16+Math.random()*26,o=26+Math.random()*22;n===1&&c>r+a*.46&&c<r+a*.6||(e.fillStyle=t[Math.random()*t.length|0],e.fillRect(c,s-o,i,o),e.fillStyle=`rgba(0,0,0,0.22)`,e.fillRect(c,s-o,i,5)),c+=i+4}}}else if(t===`ironhold`){s(`#101822`,`#25313d`);let t=e.createLinearGradient(r+a*.2,i+o,r+a*.62,i);t.addColorStop(0,`rgba(220,232,255,0.28)`),t.addColorStop(1,`rgba(220,232,255,0)`),e.fillStyle=t,e.beginPath(),e.moveTo(r+a*.24,i+o*.7),e.lineTo(r+a*.7,i),e.lineTo(r+a*.94,i),e.closePath(),e.fill(),e.fillStyle=`#141a1f`,e.fillRect(r,i+o*.62,a,o*.38);let n=[[.08,.34],[.3,.46],[.56,.3],[.78,.42]];for(let t=0;t<n.length;t++){let s=r+a*n[t][0],c=o*n[t][1];e.fillRect(s,i+o-c-o*.3,a*.13,c+o*.3);for(let t=0;t<3;t++)e.fillRect(s+t*a*.045,i+o-c-o*.34,a*.028,o*.05)}e.fillStyle=`rgba(240,180,90,0.85)`;for(let t=0;t<7;t++)e.fillRect(r+a*(.1+Math.random()*.78),i+o*(.7+Math.random()*.18),6,9)}else if(t===`nuketown`){s(`#f0a15c`,`#f6d79c`);let t=e.createRadialGradient(r+a*.5,i+o*.62,4,r+a*.5,i+o*.62,a*.34);t.addColorStop(0,`rgba(255,250,232,0.95)`),t.addColorStop(.4,`rgba(255,214,150,0.55)`),t.addColorStop(1,`rgba(255,190,120,0)`),e.fillStyle=t,e.fillRect(r,i,a,o),e.fillStyle=`#6a4630`,e.fillRect(r,i+o*.74,a,o*.26);function n(t,n){e.save(),e.translate(t,i+o*.74),e.scale(n,1),e.fillStyle=`#3d2a20`,e.fillRect(-52,-60,104,60),e.beginPath(),e.moveTo(-62,-60),e.lineTo(0,-96),e.lineTo(62,-60),e.closePath(),e.fill(),e.fillStyle=`rgba(255,232,180,0.8)`,e.fillRect(-34,-46,24,22),e.fillRect(12,-46,24,22),e.restore()}n(r+a*.19,1),n(r+a*.81,-1),e.strokeStyle=`rgba(240,232,210,0.6)`,e.lineWidth=5,e.setLineDash([18,16]),e.beginPath(),e.moveTo(r+a*.5,i+o*.76),e.lineTo(r+a*.5,i+o),e.stroke(),e.setLineDash([])}e.fillStyle=`rgba(92,72,40,0.16)`,e.fillRect(r,i,a,o);for(let t=0;t<40;t++)e.fillStyle=`rgba(30,20,8,`+(.04+Math.random()*.1)+`)`,e.beginPath(),e.arc(r+Math.random()*a,i+Math.random()*o,2+Math.random()*9,0,Math.PI*2),e.fill()}function Yf(e,t,n,r,i,a){let o=[],s={};function c(t,a,c){if(s[t+`,`+a]||Math.abs(t-9)<=2&&Math.abs(a-9)<=2)return;let l=Al(t,a);if(Xf(l,n,7)||Xf(l,r,7))return;let u=[[1,0],[-1,0],[0,1],[0,-1]].filter(function(n){let r=t+n[0],i=a+n[1];return r>=0&&i>=0&&r<19&&i<19&&!e[r][i]});if(!u.length)return;let d=u[Math.random()*u.length|0],f=l.x+d[0]*(Dl*.5-.06),p=l.z+d[1]*(Dl*.5-.06);for(let e=0;e<o.length;e++){let t=o[e].x-f,n=o[e].z-p;if(t*t+n*n<c*c)return}for(let e=0;e<i.length;e++){let t=i[e].x-f,n=i[e].z-p;if(t*t+n*n<4)return}let m=-d[0],h=-d[1],g=h,_=-m,v=t+g,y=a+_,b=v>=0&&y>=0&&v<19&&y<19&&e[v][y];s[t+`,`+a]=!0,o.push({x:f,z:p,outX:m,outZ:h,rightX:g,rightZ:_,signSide:b?1:-1})}let l=[12,9,6.5,4];for(let e=0;e<l.length&&o.length<a;e++)for(let n=0;n<t.length&&o.length<a;n++)c(t[n][0],t[n][1],l[e]);return o}function Xf(e,t,n){let r=e.x-t.x,i=e.z-t.z;return r*r+i*i<n*n}function Zf(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(64,64,0,64,64,64);return n.addColorStop(0,`rgba(255,255,255,0.62)`),n.addColorStop(.18,`rgba(226,180,255,0.34)`),n.addColorStop(.55,`rgba(150,80,220,0.12)`),n.addColorStop(1,`rgba(120,60,200,0)`),t.fillStyle=n,t.fillRect(0,0,128,128),new zi(e)}function Qf(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`);t.translate(64,64),t.scale(1,1.35);let n=t.createRadialGradient(0,-18,2,0,-18,58);return n.addColorStop(0,`rgba(238,214,255,0.85)`),n.addColorStop(.35,`rgba(180,110,235,0.34)`),n.addColorStop(1,`rgba(140,70,210,0)`),t.fillStyle=n,t.fillRect(-64,-64,128,128),new zi(e)}function $f(){let e=document.createElement(`canvas`);e.width=e.height=32;let t=e.getContext(`2d`),n=t.createRadialGradient(16,16,0,16,16,16);return n.addColorStop(0,`rgba(255,255,255,0.95)`),n.addColorStop(.4,`rgba(232,200,255,0.5)`),n.addColorStop(1,`rgba(200,150,255,0)`),t.fillStyle=n,t.fillRect(0,0,32,32),new zi(e)}var ep=new Ht(0,0,0,`YXZ`),tp=new U,np={type:`change`},rp={type:`lock`},ip={type:`unlock`},ap=.002,op=Math.PI/2,sp=class extends so{constructor(e,t=null){super(e,t),this.isLocked=!1,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.pointerSpeed=1,this._onMouseMove=cp.bind(this),this._onPointerlockChange=lp.bind(this),this._onPointerlockError=up.bind(this),this.domElement!==null&&this.connect(this.domElement)}connect(e){super.connect(e),this.domElement.ownerDocument.addEventListener(`mousemove`,this._onMouseMove),this.domElement.ownerDocument.addEventListener(`pointerlockchange`,this._onPointerlockChange),this.domElement.ownerDocument.addEventListener(`pointerlockerror`,this._onPointerlockError)}disconnect(){this.domElement.ownerDocument.removeEventListener(`mousemove`,this._onMouseMove),this.domElement.ownerDocument.removeEventListener(`pointerlockchange`,this._onPointerlockChange),this.domElement.ownerDocument.removeEventListener(`pointerlockerror`,this._onPointerlockError)}dispose(){this.disconnect()}getDirection(e){return e.set(0,0,-1).applyQuaternion(this.object.quaternion)}moveForward(e){if(this.enabled===!1)return;let t=this.object;tp.setFromMatrixColumn(t.matrix,0),tp.crossVectors(t.up,tp),t.position.addScaledVector(tp,e)}moveRight(e){if(this.enabled===!1)return;let t=this.object;tp.setFromMatrixColumn(t.matrix,0),t.position.addScaledVector(tp,e)}lock(e=!1){this.domElement.requestPointerLock({unadjustedMovement:e})}unlock(){this.domElement.ownerDocument.exitPointerLock()}};function cp(e){if(this.enabled===!1||this.isLocked===!1)return;let t=this.object;ep.setFromQuaternion(t.quaternion),ep.y-=e.movementX*ap*this.pointerSpeed,ep.x-=e.movementY*ap*this.pointerSpeed,ep.x=Math.max(op-this.maxPolarAngle,Math.min(op-this.minPolarAngle,ep.x)),t.quaternion.setFromEuler(ep),this.dispatchEvent(np)}function lp(){this.domElement.ownerDocument.pointerLockElement===this.domElement?(this.dispatchEvent(rp),this.isLocked=!0):(this.dispatchEvent(ip),this.isLocked=!1)}function up(){console.error(`THREE.PointerLockControls: Unable to use Pointer Lock API`)}var dp=1.62,fp=2.05,pp=1.5,mp=.26;function hp(e){let t=e.camera,n=e.domElement,r=e.isOpen,i=e.reduceMotion,a=e.onStep,o=e.obstacles||[],s={};window.addEventListener(`keydown`,function(e){s[e.key.toLowerCase()]=!0,[`arrowup`,`arrowdown`,`arrowleft`,`arrowright`,` `].indexOf(e.key.toLowerCase())>-1&&e.preventDefault()}),window.addEventListener(`keyup`,function(e){s[e.key.toLowerCase()]=!1});let c=Math.atan2(e.exitPos.x-e.startPos.x,e.exitPos.z-e.startPos.z),l=0,u=!1,d=0,f=0;t.position.set(e.startPos.x,dp,e.startPos.z),t.rotation.order=`YXZ`;let p=.98,m=-.55,h=new sp(t,n);h.minPolarAngle=Math.PI/2-p,h.maxPolarAngle=Math.PI/2-m,h.pointerSpeed=.6;function g(){let e=n.requestPointerLock();e&&e.catch&&e.catch(function(){})}n.addEventListener(`click`,g),n.addEventListener(`pointerdown`,function(e){h.isLocked||(u=!0,d=e.clientX,f=e.clientY)}),window.addEventListener(`pointerup`,function(){u=!1}),window.addEventListener(`pointermove`,function(e){!u||h.isLocked||(c-=(e.clientX-d)*.0035,l=Math.max(m,Math.min(p,l-(e.clientY-f)*.0035)),d=e.clientX,f=e.clientY)});let _=0,v=0;function y(e,t){let n=Math.round(e/Dl+18/2),i=Math.round(t/Dl+18/2);for(let a=-1;a<=1;a++)for(let o=-1;o<=1;o++){let s=n+a,c=i+o;if(s<0||c<0||s>=19||c>=19||r[s][c])continue;let l=Al(s,c);if(Math.abs(e-l.x)<1.84&&Math.abs(t-l.z)<1.84)return!0}for(let n=0;n<o.length;n++){let r=o[n],i=e-r.x,a=t-r.z;if(r.r!==void 0){let e=r.r+mp;if(i*i+a*a<e*e)return!0}else{let e=r.turn||0,t=Math.cos(-e),n=Math.sin(-e),o=i*t-a*n,s=i*n+a*t;if(Math.abs(o)<r.hw+mp&&Math.abs(s)<r.hd+mp)return!0}}return!1}function b(e){h.isLocked&&(c=t.rotation.y,l=t.rotation.x),s.arrowleft&&(c+=pp*e),s.arrowright&&(c-=pp*e);let n=0,r=0;(s.w||s.arrowup)&&(n-=Math.sin(c),r-=Math.cos(c)),(s.s||s.arrowdown)&&(n+=Math.sin(c),r+=Math.cos(c)),s.a&&(n-=Math.cos(c),r+=Math.sin(c)),s.d&&(n+=Math.cos(c),r-=Math.sin(c));let o=Math.sqrt(n*n+r*r);if(o>.001){n/=o,r/=o,_+=e*6.4;let i=t.position.x+n*fp*e,s=t.position.z+r*fp*e;y(i,t.position.z)||(t.position.x=i),y(t.position.x,s)||(t.position.z=s),_-v>Math.PI&&(v=_,a&&a())}t.position.y=dp+(o>.001&&!i?Math.sin(_)*.042:0),t.rotation.set(l,c,0)}return{update:b,lock:g,controls:h}}var $=null,gp=null,_p=!0,vp=0,yp=null;function bp(e){vp=e,yp&&$&&yp.gain.setTargetAtTime(.34-.12*vp,$.currentTime,1.5)}var xp=null,Sp=null,Cp=null,wp=null,Tp=null,Ep=null,Dp=null,Op=null;function kp(){if($)return;let e=window.AudioContext||window.webkitAudioContext;if(!e){_p=!1;return}$=new e,gp=$.createGain(),gp.gain.value=.5,gp.connect($.destination);let t=$.sampleRate*4,n=$.createBuffer(1,t,$.sampleRate),r=n.getChannelData(0),i=0;for(let e=0;e<t;e++){let t=Math.random()*2-1;i=(i+.02*t)/1.02,r[e]=i*4}let a=$.createBufferSource();a.buffer=n,a.loop=!0;let o=$.createBiquadFilter();o.type=`lowpass`,o.frequency.value=460,yp=$.createGain(),yp.gain.value=.34,a.connect(o),o.connect(yp),yp.connect(gp),a.start();let s=$.createOscillator();s.frequency.value=.055;let c=$.createGain();c.gain.value=240,s.connect(c),c.connect(o.frequency),s.start(),Ap(),jp(),Mp(),Np(),Xp(),Zp(),Qp(),$p()}function Ap(){let e=$.sampleRate*3,t=$.createBuffer(1,e,$.sampleRate),n=t.getChannelData(0);for(let t=0;t<e;t++)n[t]=Math.random()*2-1;let r=$.createBufferSource();r.buffer=t,r.loop=!0;let i=$.createBiquadFilter();i.type=`highpass`,i.frequency.value=900;let a=$.createBiquadFilter();a.type=`lowpass`,a.frequency.value=5200;let o=$.createBiquadFilter();o.type=`bandpass`,o.frequency.value=480,o.Q.value=.6,xp=$.createGain(),xp.gain.value=0,r.connect(i),i.connect(a),a.connect(xp),r.connect(o),o.connect(xp),xp.connect(gp),r.start()}function jp(){Sp=$.createGain(),Sp.gain.value=0,Sp.connect(gp),Cp=[];let e=[58,60.7,87];for(let t=0;t<e.length;t++){let n=$.createOscillator();n.type=t===2?`triangle`:`sine`,n.frequency.value=e[t];let r=$.createGain();r.gain.value=t===2?.35:1,n.connect(r),r.connect(Sp),n.start(),Cp.push(n)}}function Mp(){wp=$.createGain(),wp.gain.value=0;let e=$.createBiquadFilter();e.type=`bandpass`,e.frequency.value=620,e.Q.value=2.2,wp.connect(e),e.connect(gp),Tp=$.createOscillator(),Tp.type=`sawtooth`,Tp.frequency.value=196,Tp.connect(wp),Tp.start();let t=$.createOscillator();t.type=`sine`,t.frequency.value=5.4;let n=$.createGain();n.gain.value=22,t.connect(n),n.connect(Tp.frequency),t.start()}function Np(){Ep=$.createGain(),Ep.gain.value=0,Ep.connect(gp);let e=$.sampleRate*3,t=$.createBuffer(1,e,$.sampleRate),n=t.getChannelData(0);for(let t=0;t<e;t++)n[t]=Math.random()*2-1;let r=$.createBufferSource();r.buffer=t,r.loop=!0,Dp=$.createBiquadFilter(),Dp.type=`bandpass`,Dp.frequency.value=700,Dp.Q.value=3.4;let i=$.createGain();i.gain.value=1.6,r.connect(Dp),Dp.connect(i),i.connect(Ep),r.start();let a=$.createOscillator();a.frequency.value=.085;let o=$.createGain();o.gain.value=300,a.connect(o),o.connect(Dp.frequency),a.start(),Op=[];let s=[82.4,123.5,164.8];for(let e=0;e<s.length;e++){let t=$.createOscillator();t.type=`sine`,t.frequency.value=s[e]*(1+(Math.random()-.5)*.004);let n=$.createGain();n.gain.value=[.36,.22,.1][e],t.connect(n),n.connect(Ep),t.start(),Op.push(t)}}var Pp=-1,Fp=-1,Ip=-1,Lp=-1;function Rp(e){!xp||!$||Math.abs(e-Pp)<.01||(Pp=e,xp.gain.setTargetAtTime(.16*e,$.currentTime,1.2))}function zp(e){!Sp||!$||Math.abs(e-Fp)<.01||(Fp=e,Sp.gain.setTargetAtTime(.055*e*e,$.currentTime,.35),Cp[0].frequency.setTargetAtTime(58-6*e,$.currentTime,.5))}function Bp(e){!wp||!$||Math.abs(e-Ip)<.01||(Ip=e,wp.gain.setTargetAtTime(.05*e,$.currentTime,.25),Tp.frequency.setTargetAtTime(196+60*e,$.currentTime,.4))}function Vp(e){!Ep||!$||Math.abs(e-Lp)<.01||(Lp=e,Ep.gain.setTargetAtTime(.075*e*e,$.currentTime,.45),Dp.Q.setTargetAtTime(3.4+3*e,$.currentTime,.6),Op[0].frequency.setTargetAtTime(82.4+5*e,$.currentTime,.7))}function Hp(){if(!(!$||!_p)){Gp(140,1180,1.35,`sine`,.11,0),Gp(210,1770,1.2,`triangle`,.045,0);for(let e=0;e<9;e++)setTimeout(function(){Wp(.34,500+e*460,1.1,.055,(Math.random()-.5)*1.2)},e*110)}}function Up(e,t){return Math.max(0,1-e/(t||25))}function Wp(e,t,n,r,i){if(!$||!_p||r<=8e-4)return;let a=$.sampleRate*e|0,o=$.createBuffer(1,a,$.sampleRate),s=o.getChannelData(0);for(let e=0;e<a;e++){let t=1-e/a;s[e]=(Math.random()*2-1)*t*t}let c=$.createBufferSource();c.buffer=o;let l=$.createBiquadFilter();l.type=`bandpass`,l.frequency.value=t,l.Q.value=n;let u=$.createGain();if(u.gain.value=r,c.connect(l),l.connect(u),$.createStereoPanner){let e=$.createStereoPanner();e.pan.value=i||0,u.connect(e),e.connect(gp)}else u.connect(gp);c.start()}function Gp(e,t,n,r,i,a){if(!$||!_p||i<=8e-4)return;let o=$.createOscillator();o.type=r||`sine`,o.frequency.setValueAtTime(e,$.currentTime),o.frequency.exponentialRampToValueAtTime(Math.max(20,t),$.currentTime+n);let s=$.createGain();if(s.gain.setValueAtTime(1e-4,$.currentTime),s.gain.linearRampToValueAtTime(i,$.currentTime+.015),s.gain.exponentialRampToValueAtTime(1e-4,$.currentTime+n),o.connect(s),$.createStereoPanner){let e=$.createStereoPanner();e.pan.value=a||0,s.connect(e),e.connect(gp)}else s.connect(gp);o.start(),o.stop($.currentTime+n+.05)}function Kp(e,t){if(!$||!_p)return;let n=Up(t);if(n<=.01)return;let r=Math.random()*1.2-.6;if(e===`deer`)Wp(.16,320,1.1,.075*n,r),setTimeout(function(){Wp(.1,260,1.4,.045*n,r)},150);else if(e===`turkey`){let e=5+(Math.random()*4|0);for(let t=0;t<e;t++)setTimeout(function(){Gp(520+Math.random()*280,300+Math.random()*120,.075,`sawtooth`,.03*n,r)},t*72)}else if(e===`chitter`)for(let e=0;e<4;e++)setTimeout(function(){Yp(1500+Math.random()*700,.035,`triangle`,.026*n,r)},e*55);else if(e===`crow`){let e=2+(Math.random()*2|0);for(let t=0;t<e;t++)setTimeout(function(){Gp(760,430,.24,`sawtooth`,.042*n,r),Wp(.22,1400,.9,.03*n,r)},t*340)}else if(e===`bolt`)for(let e=0;e<5;e++)setTimeout(function(){Wp(.14,1800+Math.random()*1800,.6,.075*n,r)},e*85+Math.random()*40);else if(e===`rattle`)for(let e=0;e<14;e++)setTimeout(function(){Wp(.035,5200+Math.random()*2600,1.6,.055*Up(t,14),r)},e*42);else e===`buzzUp`?Gp(220,340,.5,`sawtooth`,.02*Up(t,12),r):e===`drip`&&(Gp(760,1580,.11,`sine`,.055*Up(t,14),r),setTimeout(function(){Gp(1100,1900,.07,`sine`,.022*Up(t,14),r)},90))}function qp(){$&&$.state===`suspended`&&$.resume()}function Jp(){return _p=!_p,gp&&(gp.gain.value=_p?.5:0),_p}function Yp(e,t,n,r,i){if(!$||!_p)return;let a=$.createOscillator();a.type=n||`sine`,a.frequency.value=e;let o=$.createGain();if(o.gain.setValueAtTime(1e-4,$.currentTime),o.gain.linearRampToValueAtTime(r,$.currentTime+.02),o.gain.exponentialRampToValueAtTime(1e-4,$.currentTime+t),a.connect(o),$.createStereoPanner){let e=$.createStereoPanner();e.pan.value=i||0,o.connect(e),e.connect(gp)}else o.connect(gp);a.start(),a.stop($.currentTime+t+.05)}function Xp(){let e=.05*(1-vp);if(_p&&e>.004){let t=2+(Math.random()*3|0),n=1750+Math.random()*1300,r=Math.random()*2-1;for(let i=0;i<t;i++)setTimeout(function(){Yp(n+Math.random()*340-120,.13,`sine`,e,r)},i*135)}setTimeout(Xp,2400+Math.random()*5200)}function Zp(){let e=.016*(1-vp*.85);_p&&e>.002&&Yp(4100+Math.random()*900,.055,`triangle`,e,Math.random()*2-1),setTimeout(Zp,110+Math.random()*300)}function Qp(){let e=.019*vp;if(_p&&e>.002){let t=3+(Math.random()*2|0),n=2350+Math.random()*700,r=Math.random()*2-1;for(let i=0;i<t;i++)setTimeout(function(){Yp(n,.028,`triangle`,e,r)},i*42)}setTimeout(Qp,260+Math.random()*700)}function $p(){let e=.035*vp;if(_p&&e>.004){let t=360+Math.random()*60,n=Math.random()*1.4-.7;Yp(t,.42,`sine`,e,n),setTimeout(function(){Yp(t*.92,.55,`sine`,e*.85,n)},620)}setTimeout($p,17e3+Math.random()*34e3)}function em(){Yp(1350+Math.random()*520,.65,`sine`,.085,0)}function tm(){if(!$||!_p)return;let e=$.createBuffer(1,$.sampleRate*.2|0,$.sampleRate),t=e.getChannelData(0);for(let e=0;e<t.length;e++){let n=1-e/t.length;t[e]=(Math.random()*2-1)*n*n}let n=$.createBufferSource();n.buffer=e;let r=$.createBiquadFilter();r.type=`bandpass`,r.frequency.value=2e3+Math.random()*1700,r.Q.value=.7;let i=$.createGain();i.gain.value=.055,n.connect(r),r.connect(i),i.connect(gp),n.start()}var nm=window.matchMedia&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,rm=jl(),im=rm.isOpen,am=rm.exitPos,{scene:om,camera:sm,renderer:cm,maxAniso:lm,daylight:um}=wu(im),dm=Fu(im,lm);om.add(dm.mesh);var fm=Nl(im);fm.sort(function(){return Math.random()-.5});var pm=Uu(rm.startPos,am,lm);om.add(pm.group);var mm=Ad(lm);om.add(mm.group);var hm=yd(im,fm,rm.startPos,am,[mm.flame]);om.add(hm.group);var gm=Hd(im,lm);om.add(gm.group);var _m=Rf(im,fm,rm.startPos,am,hm.obstacles,Am);om.add(_m.group);var vm=wf(om);om.traverse(function(e){e.isMesh&&e.material&&e.material.isMeshStandardMaterial&&vm.patch(e.material)});var ym=hp({camera:sm,domElement:cm.domElement,isOpen:im,startPos:rm.startPos,exitPos:am,reduceMotion:nm,obstacles:pm.obstacles.concat(hm.obstacles,mm.obstacles,_m.obstacles),onStep:tm}),bm=new Xi(.13,10,8),xm=new J({color:16767075,emissive:13868060,emissiveIntensity:.85,roughness:.35}),Sm=[],Cm=Math.min(34,fm.length);for(let e=0;e<Cm;e++){let t=fm[e];if(t[0]===1&&t[1]===rm.entranceRow*2+1)continue;let n=Al(t[0],t[1]),r=new q(bm,xm);r.position.set(n.x+(Math.random()-.5)*1.3,.34,n.z+(Math.random()-.5)*1.3),om.add(r),Sm.push({mesh:r,phase:Math.random()*6.28,done:!1})}var wm=0,Tm=1.78,Em=new za(16771499,1.8*ru*Tm,16,1);Em.position.set(am.x,1.5,am.z),om.add(Em);var Dm=new q(new Gi(.1,.1,3.4,8),new Br({color:16774092,transparent:!0,opacity:.42,blending:2,depthWrite:!1,fog:!1}));Dm.position.set(am.x,1.7,am.z),om.add(Dm);var Om=!1,km=null;function Am(e){if(km)return;km=e,Hp(),document.pointerLockElement&&document.exitPointerLock();let t=document.getElementById(`portalFade`),n=new K(e.b),r=`rgb(`+Math.round(n.r*255)+`,`+Math.round(n.g*255)+`,`+Math.round(n.b*255)+`)`;t.style.background=`radial-gradient(ellipse at 50% 52%, `+r+` 0%, #170b28 62%, #05030a 100%)`,t.querySelector(`.dest`).textContent=e.name||``,t.classList.add(`on`),setTimeout(function(){window.location.href=e.url},1450)}var jm=[],Mm=new Xi(.05,6,6);for(let e=0;e<20;e++){let e=fm[Math.random()*fm.length|0],t=Al(e[0],e[1]),n=new q(Mm,new Br({color:16774072,fog:!1,transparent:!0,opacity:0}));n.position.set(t.x,1,t.z),om.add(n),jm.push({mesh:n,cx:t.x,cz:t.z,cy:.85+Math.random()*.7,r1:.7+Math.random()*1,r2:.6+Math.random()*.9,speed:.22+Math.random()*.26,phase:Math.random()*6.28,bob:.28+Math.random()*.3})}var Nm=550,Pm=new ur,Fm=new Float32Array(Nm*3),Im=new Float32Array(Nm);for(let e=0;e<Nm;e++)Fm[e*3]=(Math.random()-.5)*Ol,Fm[e*3+1]=Math.random()*4.2,Fm[e*3+2]=(Math.random()-.5)*Ol,Im[e]=.04+Math.random()*.1;Pm.setAttribute(`position`,new Yn(Fm,3));var Lm=new Ii(Pm,new ji({size:.085,map:Rm(),transparent:!0,depthWrite:!1,blending:2,opacity:.6}));om.add(Lm);function Rm(){let e=document.createElement(`canvas`);e.width=e.height=32;let t=e.getContext(`2d`),n=t.createRadialGradient(16,16,0,16,16,16);return n.addColorStop(0,`rgba(255,244,206,0.95)`),n.addColorStop(1,`rgba(255,244,206,0)`),t.fillStyle=n,t.fillRect(0,0,32,32),new zi(e)}var zm=0;function Bm(e,t){let n=document.getElementById(`toast`);n.textContent=e,n.style.opacity=`1`,clearTimeout(zm),zm=setTimeout(function(){n.style.opacity=`0`},t||2800)}document.getElementById(`soundToggle`).addEventListener(`click`,function(){let e=Jp();this.innerHTML=e?`&#128266; sound on`:`&#128264; sound off`}),window.addEventListener(`keydown`,function(e){(e.key===`r`||e.key===`R`)&&vm.shower()});var Vm=!1;document.getElementById(`enterBtn`).addEventListener(`click`,function(){kp(),qp(),ym.lock();let e=document.getElementById(`overlay`);e.classList.add(`fadeOut`),setTimeout(function(){e.style.display=`none`},1700),document.getElementById(`hud`).style.display=`flex`,document.getElementById(`soundToggle`).style.display=`block`,Vm=!0,Bm(`the corn closes in behind you…`,3600)});var Hm=new oo,Um=!1,Wm=!1,Gm=!1,Km=!1,qm=!1;function Jm(){requestAnimationFrame(Jm);let e=Math.min(Hm.getDelta(),.05),t=Hm.elapsedTime;dm.uTime.value=nm?0:t,pm.uTime.value=nm?0:t,um.weather.fogBoost=vm.fogBoost,um.weather.lightDamp=vm.lightDamp,um.update(Vm?e:0,t);let n=um.night;bp(n),pm.update(n),hm.update(t,n,sm.position),vm.update(Vm?e:0,sm.position,um.elevation,n,om.fog.color),Rp(vm.state.rain),Vm&&(gm.update(e,t,sm.position,n,Kp),zp(gm.danger),Bp(gm.buzz),mm.update(e,t,sm.position,function(e){Kp(`drip`,e)})),_m.update(e,t,sm.position,n),Vp(_m.level),Vm&&!Um&&n>.97&&(Um=!0,Bm(`the field has gone blue. the lanterns are lit`,5200)),Vm&&Um&&!Wm&&n<.03&&um.elevation>0&&(Wm=!0,Bm(`morning, and the mist is still in the rows`,5200)),Vm&&!Gm&&vm.state.rain>.25&&(Gm=!0,Bm(`rain, a little of it, going through the corn`,5200)),Vm&&!Km&&mm.inside(sm.position)&&(Km=!0,Bm(`somebody rakes this. the lines will close over your prints`,6e3)),Vm&&!qm&&_m.level>.55&&(qm=!0,Bm(`a door in the corn, and not made of corn. step into it and the field lets you go`,7e3));for(let e=0;e<jm.length;e++){let r=jm[e],i=t*r.speed+r.phase;r.mesh.position.set(r.cx+Math.sin(i)*r.r1,r.cy+Math.sin(i*1.7)*r.bob,r.cz+Math.cos(i*.83)*r.r2);let a=.5+.5*Math.sin(t*2.6+r.phase*5);r.mesh.material.color.setRGB(1,.93,.55+a*.25),r.mesh.scale.setScalar(.6+a*.7),r.mesh.material.opacity=n,r.mesh.visible=n>.01}Lm.material.opacity=.6-.42*n;let r=Lm.geometry.attributes.position.array;for(let n=0;n<Nm;n++)r[n*3+1]+=Im[n]*e,r[n*3]+=Math.sin(t*.28+n)*.0035,r[n*3+1]>4.4&&(r[n*3+1]=0);Lm.geometry.attributes.position.needsUpdate=!0;for(let e=0;e<Sm.length;e++){let n=Sm[e];if(n.done)continue;n.mesh.position.y=.3+Math.sin(t*1.4+n.phase)*.055,n.mesh.rotation.y=t*.7;let r=sm.position.x-n.mesh.position.x,i=sm.position.z-n.mesh.position.z;Vm&&r*r+i*i<.28&&(n.done=!0,om.remove(n.mesh),wm++,document.getElementById(`kernelCount`).textContent=`kernels found: `+wm,em())}if(Dm.material.opacity=.3+Math.sin(t*1.8)*.14,Em.intensity=(1.55+Math.sin(t*1.8)*.35)*ru*Tm,Vm&&!Om){let e=sm.position.x-am.x,t=sm.position.z-am.z;e*e+t*t<5.5&&(Om=!0,Bm(`you found the edge of the field — there is a bench out there, if you want it`,6e3))}Vm&&!km&&ym.update(e),cm.render(om,sm)}Jm();