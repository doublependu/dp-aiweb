...
import { C, RINGS, DENS_POW } from './core/config.js';
import { clamp, rng, smoothstep } from './core/math.js';
import { GL_UNI, GL_PAL, GL_HASH, GL_NOISE, GL_TERRAIN, GL_WIND, GL_CLOUDFIELD, GL_SHADOW, GL_LIGHT, GL_AIR, VHEAD, FHEAD } from './core/glsl.js';
...
export function buildBladeGeometry(segs){
...
export function buildBladeInstances(geom, chunkSize, count, seed){
  const r = rng(seed);
...
export const GRASS_VS = (depthOnly)=> /* glsl */`
${GL_UNI}
...
export const GRASS_FS = (tier)=> /* glsl */`
...
export function grassBeforeRender(){
