...
import { PB, pv, pq, pt3, pbox, pcyl, finishPainted, LC, tint, mixc, PAINTED_VS, PAINTED_FS } from './core/mesh-utils.js';
import { RSM } from './core/engine.js';
import { TRACK, trackPose } from './railway.js';
...
export function buildWheel(R, spokes, col){
...
export function buildRod(len, thick, col){
  const M=PB();
...
export function buildCarriage(i){
  const M=PB();
