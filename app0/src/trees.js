...
import { TAU, clamp, lerp, rng, noise2 } from './core/math.js';
import { GL_UNI, GL_PAL, GL_HASH, GL_NOISE, GL_TERRAIN, GL_WIND, GL_CLOUDFIELD, GL_SHADOW, GL_LIGHT, GL_AIR } from './core/glsl.js';
import { sampleHeight, sampleNormal, riverField, riverWidth, waterLevel, pathDistance, VILLAGE, BRIDGE, RIVER_PTS } from './terrain.js';
...
export const MeshBuf = () => ({ pos:[], nrm:[], clm:[], flx:[], hue:[], idx:[], n:0 });
export function pushVert(M, x,y,z, nx,ny,nz, cx,cy,cz, flex, hue){
...
export function addTube(M, pts, radii, seg, hueV){
  const rings=[];
...
export function addClump(M, cx,cy,cz, rx,ry,rz, seed, hueV, detail){
